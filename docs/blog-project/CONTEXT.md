...
3. **Velocity ceiling** — 2-3 posts/day max, 3/week minimum
4. **Water damage consolidation** — 20 posts collapse to 5 pillar/spoke structure
5. **Image strategy** — original workshop photos only, descriptive filenames, WebP format
...
- **SKILL.md** — Perfect Blog Creator skill instructions (drop into /mnt/skills/user/perfect-blog-creator/)
- **README.md** — Package overview and quick start
- **DEPLOYMENT.md** — Step-by-step deployment runbook for Claude Code
...
- **components/SiteSchema.tsx** — Site-wide Organization + LocalBusiness schema
...
### Configuration
- **config/next.config.redirects.js** — 301 redirect map for water damage consolidation
