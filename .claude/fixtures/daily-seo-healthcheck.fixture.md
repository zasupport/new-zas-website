# Fixture / equivalent-control record for scripts/daily-seo-healthcheck.*
...
# Executable control (run to verify): python3 scripts/daily-seo-healthcheck.py --test    (or: bash scripts/daily-seo-healthcheck.sh --test)
