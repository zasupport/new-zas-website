# Fixture / equivalent-control record for scripts/discovery-self-gap-pass1.*
...
# Executable control (run to verify): python3 scripts/discovery-self-gap-pass1.py --test    (or: bash scripts/discovery-self-gap-pass1.sh --test)
