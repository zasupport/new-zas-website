# Fixture / equivalent-control record for scripts/discovery-self-gap-merge.*
...
# Executable control (run to verify): python3 scripts/discovery-self-gap-merge.py --test    (or: bash scripts/discovery-self-gap-merge.sh --test)
