# Fixture / equivalent-control record for scripts/discovery-keyword-intent-expand.*
...
# Executable control (run to verify): python3 scripts/discovery-keyword-intent-expand.py --test    (or: bash scripts/discovery-keyword-intent-expand.sh --test)
