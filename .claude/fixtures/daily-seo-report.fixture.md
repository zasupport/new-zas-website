# Fixture / equivalent-control record for scripts/daily-seo-report.*
...
# Executable control (run to verify): python3 scripts/daily-seo-report.py --test    (or: bash scripts/daily-seo-report.sh --test)
