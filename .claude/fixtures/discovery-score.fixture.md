# Fixture / equivalent-control record for scripts/discovery-score.*
...
# Executable control (run to verify): python3 scripts/discovery-score.py --test    (or: bash scripts/discovery-score.sh --test)
