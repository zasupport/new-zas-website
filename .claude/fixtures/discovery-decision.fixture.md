# Fixture / equivalent-control record for scripts/discovery-decision.*
...
# Executable control (run to verify): python3 scripts/discovery-decision.py --test    (or: bash scripts/discovery-decision.sh --test)
