# Fixture / equivalent-control record for scripts/daily-seo-collect.*
...
# Executable control (run to verify): python3 scripts/daily-seo-collect.py --test    (or: bash scripts/daily-seo-collect.sh --test)
