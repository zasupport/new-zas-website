# Fixture / equivalent-control record for scripts/test-commercial-discovery.*
...
# Executable control (run to verify): python3 scripts/test-commercial-discovery.py --test    (or: bash scripts/test-commercial-discovery.sh --test)
