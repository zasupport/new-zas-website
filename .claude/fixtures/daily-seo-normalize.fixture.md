# Fixture / equivalent-control record for scripts/daily-seo-normalize.*
...
# Executable control (run to verify): python3 scripts/daily-seo-normalize.py --test    (or: bash scripts/daily-seo-normalize.sh --test)
