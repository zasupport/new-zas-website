# Fixture / equivalent-control record for scripts/smoke-seo-pipeline.*
...
# Executable control (run to verify): python3 scripts/smoke-seo-pipeline.py --test    (or: bash scripts/smoke-seo-pipeline.sh --test)
