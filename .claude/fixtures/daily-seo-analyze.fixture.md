# Fixture / equivalent-control record for scripts/daily-seo-analyze.*
...
# Executable control (run to verify): python3 scripts/daily-seo-analyze.py --test    (or: bash scripts/daily-seo-analyze.sh --test)
