# Fixture / equivalent-control record for scripts/discovery-report.*
...
# Executable control (run to verify): python3 scripts/discovery-report.py --test    (or: bash scripts/discovery-report.sh --test)
