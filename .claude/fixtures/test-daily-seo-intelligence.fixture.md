# Fixture / equivalent-control record for scripts/test-daily-seo-intelligence.*
...
# Executable control (run to verify): python3 scripts/test-daily-seo-intelligence.py --test    (or: bash scripts/test-daily-seo-intelligence.sh --test)
