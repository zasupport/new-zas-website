# Fixture / equivalent-control record for scripts/discovery-operationalization-check.*
...
# Executable control (run to verify): python3 scripts/discovery-operationalization-check.py --test    (or: bash scripts/discovery-operationalization-check.sh --test)
