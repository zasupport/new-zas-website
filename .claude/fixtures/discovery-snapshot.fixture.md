# Fixture / equivalent-control record for scripts/discovery-snapshot.*
...
# Executable control (run to verify): python3 scripts/discovery-snapshot.py --test    (or: bash scripts/discovery-snapshot.sh --test)
