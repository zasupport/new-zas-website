# Fixture / equivalent-control record for scripts/discovery-gap-detect.*
...
# Executable control (run to verify): python3 scripts/discovery-gap-detect.py --test    (or: bash scripts/discovery-gap-detect.sh --test)
