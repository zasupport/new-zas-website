# Fixture / equivalent-control record for scripts/discovery-self-gap-pass2.*
...
# Executable control (run to verify): python3 scripts/discovery-self-gap-pass2.py --test    (or: bash scripts/discovery-self-gap-pass2.sh --test)
