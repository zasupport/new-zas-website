# Fixture / equivalent-control record for scripts/discovery-source-health.*
...
# Executable control (run to verify): python3 scripts/discovery-source-health.py --test    (or: bash scripts/discovery-source-health.sh --test)
