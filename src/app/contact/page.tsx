...
const localBusinessSchema = {
  ...
  description: 'MacBook repair, iPhone repair, logic board component-level repair, managed IT services and Apple device support in Johannesburg. Assessment.',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-[#7A9E98] mb-6 max-w-2xl">
              Assessment. Response within 1 hour during business hours. Hyde Park, Johannesburg.
            </p>
