...
export const metadata: Metadata = {
  ...
  description:
    'Contact ZA Support in Hyde Park, Johannesburg. MacBook, iPhone and iPad repair. Assessment. Response within 1 hour. Call 064 529 5863 or WhatsApp.',
  alternates: { canonical: 'https://zasupport.com/contact' },
  openGraph: {
    title: 'Contact ZA Support: Apple Repair Johannesburg',
    description: 'MacBook, iPhone and iPad repair in Hyde Park. Assessment. Call 064 529 5863.',
