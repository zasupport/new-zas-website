    ...
    <>
      ...
      <section className="hero-gradient grid-overlay text-white pt-24 pb-16 sm:pt-32 sm:pb-24 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-2xl font-bold text-[#0FEA7A] mb-8">Assessment · Fixed quote before we start</p>
      ...
      <section className="py-12 px-4 bg-[rgba(245,158,11,0.08)] border-b border-amber-500/30">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-xl font-bold text-[#E8F4F1] mb-4">Signs your iMac needs an SSD upgrade:</h2>
      ...
      <section className="py-16 px-4 bg-[rgba(255,255,255,0.03)]">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold text-[#E8F4F1] mb-2 text-center">What changes after an SSD upgrade</h2>
          <p className="text-[#7A9E98] text-center mb-8">Real-world performance differences on a typical iMac 27"</p>
            ...
            <table className="w-full text-sm border border-[rgba(255,255,255,0.08)] rounded-xl overflow-hidden">
              <thead className="bg-[#0A1A18] text-white">
                <tr>
                  ...
                  <th className="text-left p-4 text-[#0FEA7A]">After (SSD)</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-[rgba(255,255,255,0.06)]">
                {benefits.map((row) => (
                  <tr key={row.before} className="hover:bg-[rgba(15,234,122,0.04)]">
                    <td className="p-4 text-[#7A9E98] text-xs">{['Boot time', 'App launch', 'Responsiveness', 'File speed', 'Noise'][benefits.indexOf(row)]}</td>
      ...
      <section className="py-16 px-4 bg-[rgba(255,255,255,0.015)]">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-bold text-[#E8F4F1] mb-2 text-center">iMac SSD Upgrade Options</h2>
          <p className="text-[#7A9E98] text-center mb-8">All upgrades include data migration. No hidden fees.</p>
          <div className="overflow-x-auto">
            <table className="w-full text-sm border border-[rgba(255,255,255,0.08)] rounded-xl overflow-hidden">
              <thead className="bg-[#0A1A18] text-white">
                <tr>
              ...
              <tbody className="divide-y divide-[rgba(255,255,255,0.06)]">
                {pricingRows.map((row) => (
                  <tr key={`${row.model}-${row.storage}`} className="hover:bg-[rgba(15,234,122,0.04)]">
                    <td className="p-4 text-[#B9D2CB]">{row.model}</td>
                    <td className="p-4 text-[#B9D2CB]">{row.storage}</td>
          ...
          <p className="text-center text-sm text-[#7A9E98] mt-4">
            Assessment and fixed quote before we start. Cost confirmed before any work begins.
          </p>
      ...
      <section className="py-16 px-4 bg-[rgba(255,255,255,0.015)]">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold text-[#E8F4F1] mb-8 text-center">iMac SSD Upgrade Questions</h2>
      ...
      <section className="py-12 px-4 bg-[#0FEA7A]/10 border-y border-[#0FEA7A]/20">
        <div className="max-w-3xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
          <div>
            <h3 className="font-bold text-[#E8F4F1] mb-1">Bundle with a RAM upgrade?</h3>
      ...
      <section className="py-16 px-4 bg-[#0A1A18] text-white">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-[#B9D2CB] mb-8">
            Assessment. Fixed quote. Same-day turnaround for most models.
