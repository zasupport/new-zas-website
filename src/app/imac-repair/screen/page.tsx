    ...
    <>
      ...
      <section className="bg-gradient-to-b from-slate-900 to-slate-800 text-white py-10 sm:py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-slate-300 mb-4 max-w-2xl mx-auto">
            ...
            All iMac models from 2012 onwards. Assessment: from R599 and fixed quote.
          </p>
          <p className="text-2xl font-bold text-green-400 mb-8">Assessment: from R599, contact us for a quote</p>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-slate-500 text-center mb-8">Assessment: from R599 before any commitment. Contact us for a quote.</p>
      ...
      <section className="py-16 px-4 bg-slate-900 text-white">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-slate-300 mb-8">
            Assessment: from R599. Fixed quote. Assessment: from R599.
