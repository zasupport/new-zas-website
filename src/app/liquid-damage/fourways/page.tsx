...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/liquid-damage/fourways', title: 'MacBook Liquid Damage Repair Fourways | ZA Support Hyde Park', description: 'MacBook liquid damage repair for Fourways clients. Ultrasonic cleaning, board-level diagnostics. We collect from Fourways. Assessment. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
  title: 'MacBook Liquid Damage Repair Fourways | ZA Support Hyde Park',
  description:
    'MacBook liquid damage repair for Fourways clients. Ultrasonic cleaning, board-level diagnostics. We collect from Fourways. Assessment. Call 064 529 5863.',
  alternates: { canonical: 'https://zasupport.com/liquid-damage/fourways' },
};
...
const urgentSteps = [
  ...
  { step: '03', title: 'Contact Us Now', desc: 'WhatsApp or call us immediately. Every hour increases corrosion spread. We collect from Fourways same day.' },
  ...
  { step: '06', title: 'Return to Fourways', desc: 'Your device returned clean, fully tested, with a ZA Support warranty on all repaired components.' },
];

const faqs = [
  {
    question: 'Do you collect liquid-damaged MacBooks from Fourways?',
    answer: 'Yes. We collect from homes, offices, and corporate parks throughout Fourways. Fourways is approximately 25 minutes from our Hyde Park workshop. Contact us immediately via WhatsApp, we prioritise liquid damage collections.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Yes. Liquid damage is progressive. Even if your MacBook appears to work normally, corrosion continues to develop. The most common failure pattern is a MacBook that survived weeks before suddenly failing. Early intervention is dramatically cheaper.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Assessment and cleaning can usually be completed within 24-48 hours. Complex board-level repairs may take longer depending on the components affected. We provide a specific turnaround time after the initial assessment.',
  },
];
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'MacBook Liquid Damage Repair Fourways',
  description: 'MacBook liquid damage repair for Fourways clients. Collection from Fourways. Ultrasonic cleaning, board-level repair.',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Fourways', item: 'https://zasupport.com/liquid-damage/fourways' },
  ],
};

const faqSchema = buildFaqSchema(faqs);

export default function LiquidDamageFourwaysPage() {
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[#E8F4F1] leading-tight mb-6">
              MacBook Liquid Damage Repair Fourways
              <br /><span className="text-[#0FEA7A]">, Same-day Collection</span>
            </h1>
            <p className="text-xl text-[#7A9E98] mb-4 max-w-3xl leading-relaxed">
              MacBook exposed to liquid in Fourways? Switch it off now and contact us. We collect from Fourways same day. Ultrasonic cleaning, board-level repair. Assessment.
            </p>
            <div className="flex items-center gap-2 text-[#7A9E98] text-sm mb-8">
              <MapPin className="w-4 h-4 text-[#0FEA7A]" />
              <span>We collect from Fourways, approx. 25 min to our Hyde Park workshop</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href={buildWhatsAppUrl('LIQ-FOURWAYS', 'liquid-damage')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 hover:shadow-[0_0_32px_rgba(15,234,122,0.4)] transition-all" >
                WhatsApp Now, Urgent
              </a>
      ...
      <section className="py-10 sm:py-20 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <PricingNote />
          <FAQAccordion items={faqs} title="MacBook Liquid Damage Repair Fourways, Common Questions" />
        </div>
      </section>
      ...
      <section className="py-8 sm:py-16 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-[rgba(39,80,77,0.3)] border border-[rgba(15,234,122,0.2)] rounded-3xl p-10">
            <h2 className="text-3xl font-extrabold text-[#E8F4F1] mb-3">Fourways MacBook Liquid Damage, Act Now.</h2>
            <p className="text-[#7A9E98] mb-6">Assessment. Same-day collection from Fourways. Switch it off and call us.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href={buildWhatsAppUrl('LIQ-FOURWAYS', 'liquid-damage')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 transition-all" >
                WhatsApp Now, Urgent
              </a>
              <a href={`tel:${CONTACT.phoneTel}`} className="inline-flex items-center justify-center gap-2 border border-[rgba(15,234,122,0.35)] text-[#0FEA7A] px-8 py-4 rounded-xl text-lg font-semibold hover:bg-[rgba(15,234,122,0.08)] transition-all">
                <Phone className="w-5 h-5" /> Call {CONTACT.phone}
