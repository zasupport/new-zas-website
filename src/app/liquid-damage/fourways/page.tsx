...
export const metadata: Metadata = {
  ...
  description:
    'MacBook liquid damage repair for Fourways clients. Ultrasonic cleaning, board-level diagnostics. We collect from Fourways. Assessment from R599. Call 064 529 5863.',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <p className="text-xl text-[#7A9E98] mb-4 max-w-3xl leading-relaxed">
              MacBook exposed to liquid in Fourways? Switch it off now and contact us. We collect from Fourways same day. Ultrasonic cleaning, board-level repair. Assessment from R599.
            </p>
      ...
      <section className="py-8 sm:py-16 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-[rgba(39,80,77,0.3)] border border-[rgba(15,234,122,0.2)] rounded-3xl p-10">
            ...
            <p className="text-[#7A9E98] mb-6">Assessment from R599. Same-day collection from Fourways. Switch it off and call us.</p>
