...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/liquid-damage/parkhurst', title: 'MacBook Liquid Damage Repair Parkhurst | ZA Support Hyde Park', description: 'MacBook liquid damage repair for Parkhurst clients. Ultrasonic cleaning, board-level diagnostics, same-day collection from Parkhurst. Assessment. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
  title: 'MacBook Liquid Damage Repair Parkhurst | ZA Support Hyde Park',
  description: 'MacBook liquid damage repair for Parkhurst clients. Ultrasonic cleaning, board-level diagnostics, same-day collection from Parkhurst. Assessment. Call 064 529 5863.',
  alternates: { canonical: 'https://zasupport.com/liquid-damage/parkhurst' },
};
...
const urgentSteps = [
  ...
  { step: '03', title: 'Contact Us Now', desc: 'WhatsApp or call immediately. Every hour increases corrosion spread. We arrange same-day collection from Parkhurst.' },
  ...
  { step: '06', title: 'Return to Parkhurst', desc: 'Device returned clean, fully tested, with a ZA Support warranty on all repaired components.' },
];

const faqs = [
  {
    question: 'How quickly should I contact you after liquid damage in Parkhurst?',
    answer: 'Immediately, within hours if possible. Every hour allows corrosion to spread further. We offer same-day collection from Parkhurst, approximately 10-15 minutes from our Hyde Park workshop. Speed is the single most important factor in liquid damage recovery.',
  },
  {
    question: 'Do you collect MacBooks for liquid damage repair from Parkhurst?',
    answer: 'We collect from Parkhurst, Parktown North, Greenside, and Emmarentia. WhatsApp 064 529 5863 for same-day collection.',
  },
  {
  ...
  {
    question: 'How much does MacBook liquid damage repair cost for Parkhurst clients?',
  ...
  {
    question: 'Do you repair iPhones and iPads with liquid damage from Parkhurst?',
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'MacBook Liquid Damage Repair Parkhurst',
  description: 'MacBook liquid damage repair for Parkhurst clients. Ultrasonic cleaning, component-level repair. Assessment.',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Parkhurst', item: 'https://zasupport.com/liquid-damage/parkhurst' },
  ],
};

const faqSchema = buildFaqSchema(faqs);

export default function LiquidDamageParkhurstPage() {
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <p className="text-xl text-[#7A9E98] mb-4 max-w-3xl leading-relaxed">
              Emergency MacBook liquid damage repair for Parkhurst clients. Same-day collection. Ultrasonic cleaning and component-level board repair at our Hyde Park workshop, approx 10-15 minutes from Parkhurst.
            </p>
      ...
      <section className="py-10 sm:py-20 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-[#E8F4F1] mb-8">What To Do After a Spill, Parkhurst Clients</h2>
      ...
      <section className="py-10 sm:py-20 bg-[#0A1A18]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <PricingNote />
          <FAQAccordion items={faqs} title={`MacBook Liquid Damage Repair Parkhurst, Common Questions`} />
        </div>
      </section>
