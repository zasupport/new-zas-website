...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/liquid-damage/illovo', title: 'MacBook Liquid Damage Repair Illovo | ZA Support Hyde Park', description: 'MacBook liquid damage repair for Illovo clients. Ultrasonic cleaning, board-level diagnostics. We collect from Illovo. Assessment. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
