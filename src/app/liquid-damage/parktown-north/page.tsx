...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/liquid-damage/parktown-north', title: 'MacBook Liquid Damage Repair Parktown North | ZA Support Hyde Park', description: 'MacBook liquid damage repair for Parktown North clients. Ultrasonic cleaning, component-level board repair. Assessment. Collection from Parktown North. No Fix No Fee.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
  title: 'MacBook Liquid Damage Repair Parktown North | ZA Support Hyde Park',
  description: 'MacBook liquid damage repair for Parktown North clients. Ultrasonic cleaning, component-level board repair. Assessment. Collection from Parktown North. No Fix No Fee.',
  alternates: { canonical: 'https://zasupport.com/liquid-damage/parktown-north' },
};

const faults = [
  { title: 'Coffee or Tea Spill', desc: 'The most common liquid damage we see from Parktown North clients. Coffee contains acids and sugars that accelerate corrosion on the logic board far faster than clean water. Immediate assessment gives the best repair outcome, corrosion spreads hourly once the liquid dries.' },
  { title: 'Rain or Humidity Damage', desc: 'Johannesburg\'s afternoon thunderstorms and summer humidity cause a pattern of damage we see frequently. Rain through an open bag or condensation from rapid temperature changes between air-conditioned offices and outdoor heat in Parktown North. The damage is progressive and often invisible until symptoms appear days later.' },
  ...
  { title: 'Secondary Component Failure', desc: 'After an initial liquid damage event, other components can fail weeks or months later as corrosion continues to spread. We see Parktown North clients return after an apparently successful home dry-out only to find additional circuits failing. Professional ultrasonic cleaning removes all corrosion, preventing the cascading failure pattern.' },
];

const faqs = [
  {
    question: 'Do you collect liquid-damaged MacBooks from Parktown North?',
    answer: 'Yes, same-day collection from Parktown North. For liquid damage, speed matters. Parktown North is approximately 6 km from our Hyde Park workshop, roughly 10-12 minutes by car. WhatsApp 064 529 5863 to arrange immediate collection.',
  },
  {
    question: 'How much does MacBook liquid damage repair cost for Parktown North clients?',
  ...
  {
    question: 'Do you offer No Fix No Fee for liquid damage from Parktown North?',
    answer: 'Yes. If we cannot repair the board after assessment, you pay only the assessment fee. No Fix No Fee applies to all Parktown North clients. Collection is included.',
  },
];
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'MacBook Liquid Damage Repair Parktown North',
  description: 'Ultrasonic cleaning and component-level MacBook liquid damage repair for Parktown North clients. Assessment.',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Parktown North', item: 'https://zasupport.com/liquid-damage/parktown-north' },
  ],
};

const faqSchema = buildFaqSchema(faqs);

export default function LiquidDamageParktownNorthPage() {
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <p className="text-xl text-[#7A9E98] mb-4 max-w-3xl leading-relaxed">
              Ultrasonic cleaning and component-level board repair for liquid-damaged MacBooks from Parktown North. Coffee, water, rain, condensation, all assessed and repaired at our Hyde Park workshop. Collection from Parktown North, approximately 6 km, 10-12 minutes by car.
            </p>
            <div className="flex items-center gap-2 text-[#7A9E98] text-sm mb-8">
              <MapPin className="w-4 h-4 text-[#0FEA7A]" />
              <span>Hyde Park, Johannesburg | Assessment | Same-day collection from Parktown North</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href={buildWhatsAppUrl('LD-PARKTOWNNORTH', 'liquid-damage')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 hover:shadow-[0_0_32px_rgba(15,234,122,0.4)] transition-all">
                WhatsApp for Quote
              </a>
      ...
      <section className="py-10 sm:py-20 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-[#E8F4F1] mb-4">Liquid Damage Scenarios We Repair for Parktown North Clients</h2>
          <p className="text-[#7A9E98] mb-8 leading-relaxed">Parktown North is approximately 6 km from our Hyde Park workshop. For liquid damage, proximity matters, the sooner the board reaches us, the better the repair outcome. All MacBook models from 2015 onwards are covered. Ultrasonic cleaning and component-level board repair, not board replacement.</p>
      ...
      <section className="py-10 sm:py-20 bg-[#0A1A18]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <PricingNote />
          <FAQAccordion items={faqs} title={`MacBook Liquid Damage Repair Parktown North, Common Questions`} />
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            {[
              ...
              { label: 'Battery Replacement Parktown North', href: '/battery-replacement/parktown-north' },
      ...
      <section className="py-8 sm:py-16 bg-[#0A1A18]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-[rgba(39,80,77,0.3)] border border-[rgba(15,234,122,0.2)] rounded-3xl p-10">
            ...
            <p className="text-[#7A9E98] mb-6">Same-day collection from Parktown North. Ultrasonic cleaning. Assessment. No Fix No Fee.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href={buildWhatsAppUrl('LD-PARKTOWNNORTH', 'liquid-damage')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 transition-all">
                WhatsApp for Quote
              </a>
              <a href={`tel:${CONTACT.phoneTel}`} className="inline-flex items-center justify-center gap-2 border border-[rgba(15,234,122,0.35)] text-[#0FEA7A] px-8 py-4 rounded-xl text-lg font-semibold hover:bg-[rgba(15,234,122,0.08)] transition-all">
                <Phone className="w-5 h-5" /> Call {CONTACT.phone}
