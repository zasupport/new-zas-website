...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/liquid-damage/edenvale', title: 'MacBook Liquid Damage Repair Edenvale | ZA Support Hyde Park', description: 'MacBook liquid damage repair for Edenvale clients. Ultrasonic cleaning, board-level diagnostics. We collect from Edenvale. Assessment. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
