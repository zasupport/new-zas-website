...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/liquid-damage/centurion', title: 'MacBook Liquid Damage Repair Centurion | ZA Support Hyde Park', description: 'MacBook liquid damage repair for Centurion clients. Ultrasonic cleaning, board-level diagnostics, same-day collection from Centurion. Assessment. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
  title: 'MacBook Liquid Damage Repair Centurion | ZA Support Hyde Park',
  description: 'MacBook liquid damage repair for Centurion clients. Ultrasonic cleaning, board-level diagnostics, same-day collection from Centurion. Assessment. Call 064 529 5863.',
  alternates: { canonical: 'https://zasupport.com/liquid-damage/centurion' },
};
...
const urgentSteps = [
  ...
  { step: '03', title: 'Contact Us Now', desc: 'WhatsApp or call immediately. Every hour increases corrosion spread. We arrange same-day collection from Centurion.' },
  ...
  { step: '06', title: 'Return to Centurion', desc: 'Device returned clean, fully tested, with a ZA Support warranty on all repaired components.' },
];
...
const faqs = [
  ...
  },
  {
    ...
    answer: 'We collect from Centurion including Irene, Lyttelton, Hennopspark, and Highveld. WhatsApp 064 529 5863 for same-day collection.',
  },
  {
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'MacBook Liquid Damage Repair Centurion',
  description: 'MacBook liquid damage repair for Centurion clients. Ultrasonic cleaning, component-level repair. Assessment.',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Centurion', item: 'https://zasupport.com/liquid-damage/centurion' },
  ],
};

const faqSchema = buildFaqSchema(faqs);

export default function LiquidDamageCenturionPage() {
  return (
    <>
      ...
      <section className="py-8 sm:py-16 bg-[#0A1A18]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-[rgba(39,80,77,0.3)] border border-[rgba(15,234,122,0.2)] rounded-3xl p-10">
            <h2 className="text-3xl font-extrabold text-[#E8F4F1] mb-3">Liquid Damage in Centurion? Act Now.</h2>
