...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/liquid-damage/melrose', title: 'MacBook Liquid Damage Repair Melrose | ZA Support Hyde Park', description: 'MacBook liquid damage repair for Melrose clients. Ultrasonic cleaning, board-level diagnostics. We collect from Melrose. Assessment. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
