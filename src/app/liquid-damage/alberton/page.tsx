...
const faqs = [
  {
    question: 'How quickly should I contact you after liquid damage in Alberton?',
    answer: 'Immediately — within hours if possible. Every hour that passes allows corrosion to spread further across the logic board. We offer same-day collection from Alberton, which is approximately 35 minutes from our Hyde Park workshop. The faster we can get to the board, the higher the success rate.',
  },
  {
    question: 'Do you collect MacBooks from Alberton after liquid damage?',
    answer: 'Yes. We collect from Alberton, Meyersdal, and the south Johannesburg residential belt. Contact us via WhatsApp and we will arrange the fastest possible collection.',
  },
  {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <p className="text-xl text-[#7A9E98] mb-4 max-w-3xl leading-relaxed">
              Liquid damage is time-critical. We collect from Alberton and carry out ultrasonic cleaning and board-level repair at our Hyde Park workshop, approximately 35 minutes away. Assessment from R599.
            </p>
      ...
      <section className="py-8 sm:py-16 bg-[#0A1A18]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4 text-[#7A9E98] leading-relaxed">
            ...
            <p>
              For south Johannesburg and Meyersdal residents, same-day collection from Alberton, Meyersdal, and the south Johannesburg residential belt makes a measurable difference to the success rate. We use a commercial ultrasonic bath to remove all residue and contaminants from the board, followed by a full board-level diagnostic to identify any components that were damaged by the exposure.
            </p>
            <p>
      ...
      <section className="py-8 sm:py-16 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-[rgba(39,80,77,0.3)] border border-[rgba(15,234,122,0.2)] rounded-3xl p-10">
            ...
            <p className="text-[#7A9E98] mb-6">Same-day collection from Alberton. Assessment from R599. No Fix No Fee.</p>
