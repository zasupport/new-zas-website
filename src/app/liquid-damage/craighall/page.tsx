...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/liquid-damage/craighall', title: 'MacBook Liquid Damage Repair Craighall | ZA Support Hyde Park', description: 'MacBook liquid damage repair for Craighall clients. Ultrasonic cleaning, component-level board repair. Assessment. Collection from Craighall. No Fix No Fee.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
  title: 'MacBook Liquid Damage Repair Craighall | ZA Support Hyde Park',
  description: 'MacBook liquid damage repair for Craighall clients. Ultrasonic cleaning, component-level board repair. Assessment. Collection from Craighall. No Fix No Fee.',
  alternates: { canonical: 'https://zasupport.com/liquid-damage/craighall' },
};
...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Yes. If we cannot repair the board after assessment, you pay only the assessment fee. No Fix No Fee applies to all Craighall clients. Collection is included.',
  },
];
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'MacBook Liquid Damage Repair Craighall',
  description: 'Ultrasonic cleaning and component-level MacBook liquid damage repair for Craighall clients. Assessment.',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Craighall', item: 'https://zasupport.com/liquid-damage/craighall' },
  ],
};

const faqSchema = buildFaqSchema(faqs);

export default function LiquidDamageCraighallPage() {
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <div className="flex items-center gap-2 text-[#7A9E98] text-sm mb-8">
              ...
              <span>Hyde Park, Johannesburg | Assessment | Same-day collection from Craighall</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href={buildWhatsAppUrl('LD-CRAIGHALL', 'liquid-damage')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 hover:shadow-[0_0_32px_rgba(15,234,122,0.4)] transition-all">
                WhatsApp for Quote
              </a>
      ...
      <section className="py-8 sm:py-16 bg-[#0A1A18]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-[rgba(39,80,77,0.3)] border border-[rgba(15,234,122,0.2)] rounded-3xl p-10">
            ...
            <p className="text-[#7A9E98] mb-6">Same-day collection from Craighall. Ultrasonic cleaning. Assessment. No Fix No Fee.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href={buildWhatsAppUrl('LD-CRAIGHALL', 'liquid-damage')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 transition-all">
                WhatsApp for Quote
              </a>
              <a href={`tel:${CONTACT.phoneTel}`} className="inline-flex items-center justify-center gap-2 border border-[rgba(15,234,122,0.35)] text-[#0FEA7A] px-8 py-4 rounded-xl text-lg font-semibold hover:bg-[rgba(15,234,122,0.08)] transition-all">
                <Phone className="w-5 h-5" /> Call {CONTACT.phone}
