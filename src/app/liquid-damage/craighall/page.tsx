...
export const metadata: Metadata = {
  ...
  description: 'MacBook liquid damage repair for Craighall clients. Ultrasonic cleaning, component-level board repair. Assessment from R599. Collection from Craighall. No Fix No Fee.',
...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Yes. If we cannot repair the board after assessment, you pay only the R599 assessment fee. No Fix No Fee applies to all Craighall clients. Collection is included.',
  },
];
...
const serviceSchema = {
  ...
  description: 'Ultrasonic cleaning and component-level MacBook liquid damage repair for Craighall clients. Assessment from R599.',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <div className="flex items-center gap-2 text-[#7A9E98] text-sm mb-8">
              ...
              <span>Hyde Park, Johannesburg | Assessment from R599 | Same-day collection from Craighall</span>
            </div>
      ...
      <section className="py-8 sm:py-16 bg-[#0A1A18]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-[rgba(39,80,77,0.3)] border border-[rgba(15,234,122,0.2)] rounded-3xl p-10">
            ...
            <p className="text-[#7A9E98] mb-6">Same-day collection from Craighall. Ultrasonic cleaning. Assessment from R599. No Fix No Fee.</p>
