...
const faqs = [
  ...
  { question: 'Is there an assessment policy for liquid damage?', answer: 'Yes. The assessment fee applies and includes disassembly, cleaning where needed, and a detailed written quote. If the repair is not economical, for example if multiple major components are corroded beyond reasonable cost, we will tell you that honestly and only the assessment fee applies. No surprise charges and no pressure to proceed.' },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <p className="text-xl text-[#7A9E98] mb-4 max-w-3xl leading-relaxed">
              Liquid damage on a MacBook is a race against corrosion, and Boksburg sits roughly 40 minutes from our Hyde Park workshop via the R21 and N12. We collect from Boksburg North, Bartlett, Parkdene and the CBD, then carry out ultrasonic board cleaning and component-level repair the same week. Assessment.
            </p>
      ...
      <section className="py-8 sm:py-16 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-[rgba(39,80,77,0.3)] border border-[rgba(15,234,122,0.2)] rounded-3xl p-10">
            ...
            <p className="text-[#7A9E98] mb-6">Same-day collection from Boksburg. Assessment available.</p>
