...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/liquid-damage/linden', title: 'MacBook Liquid Damage Repair Linden | ZA Support Hyde Park', description: 'MacBook liquid damage repair for Linden clients. Ultrasonic cleaning, component-level board repair. Assessment. Collection from Linden. No Fix No Fee.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
...
const serviceSchema = {
  ...
  description: 'Ultrasonic cleaning and component-level MacBook liquid damage repair for Linden clients. Assessment.',
