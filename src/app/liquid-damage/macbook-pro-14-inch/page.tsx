...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/liquid-damage/macbook-pro-14-inch', title: 'MacBook Pro 14-Inch Liquid Damage Repair Johannesburg [2026]', description: 'MacBook Pro 14-inch liquid damage repair Johannesburg. HDMI port, SD slot, MagSafe 3 corrosion specialists. Assessment. No Fix No Fee. Hyde Park workshop.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
