...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/liquid-damage/sunninghill', title: 'MacBook Liquid Damage Repair Sunninghill | ZA Support Hyde Park', description: 'MacBook liquid damage repair for Sunninghill clients. Ultrasonic cleaning, board-level diagnostics, same-day collection from Sunninghill. Assessment. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
  title: 'MacBook Liquid Damage Repair Sunninghill | ZA Support Hyde Park',
  description: 'MacBook liquid damage repair for Sunninghill clients. Ultrasonic cleaning, board-level diagnostics, same-day collection from Sunninghill. Assessment. Call 064 529 5863.',
...
const serviceSchema = {
  ...
  description: 'MacBook liquid damage repair for Sunninghill clients. Ultrasonic cleaning, component-level repair. Assessment.',
