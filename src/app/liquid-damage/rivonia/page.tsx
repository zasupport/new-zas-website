...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/liquid-damage/rivonia', title: 'MacBook Liquid Damage Repair Rivonia | ZA Support Hyde Park', description: 'MacBook liquid damage repair for Rivonia clients. Ultrasonic cleaning, board-level diagnostics, same-day collection from Rivonia. Assessment. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
  title: 'MacBook Liquid Damage Repair Rivonia | ZA Support Hyde Park',
  description: 'MacBook liquid damage repair for Rivonia clients. Ultrasonic cleaning, board-level diagnostics, same-day collection from Rivonia. Assessment. Call 064 529 5863.',
  alternates: { canonical: 'https://zasupport.com/liquid-damage/rivonia' },
};
...
const urgentSteps = [
  ...
  { step: '03', title: 'Contact Us Now', desc: 'WhatsApp or call immediately. Every hour increases corrosion spread. We arrange same-day collection from Rivonia.' },
  ...
  { step: '06', title: 'Return to Rivonia', desc: 'Device returned clean, fully tested, with a ZA Support warranty on all repaired components.' },
];

const faqs = [
  {
    question: 'How quickly should I contact you after liquid damage in Rivonia?',
    answer: 'Immediately, within hours if possible. Every hour allows corrosion to spread further. We offer same-day collection from Rivonia, approximately 15-20 minutes from our Hyde Park workshop. Speed is the single most important factor in liquid damage recovery.',
  },
  {
    question: 'Do you collect MacBooks for liquid damage repair from Rivonia?',
    answer: 'We collect from Rivonia, Sandton, Paulshof, and Sunninghill. WhatsApp 064 529 5863 for same-day collection.',
  },
  {
  ...
  {
    question: 'How much does MacBook liquid damage repair cost for Rivonia clients?',
  ...
  {
    question: 'Do you repair iPhones and iPads with liquid damage from Rivonia?',
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'MacBook Liquid Damage Repair Rivonia',
  description: 'MacBook liquid damage repair for Rivonia clients. Ultrasonic cleaning, component-level repair. Assessment.',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Rivonia', item: 'https://zasupport.com/liquid-damage/rivonia' },
  ],
};

const faqSchema = buildFaqSchema(faqs);

export default function LiquidDamageRivoniaPage() {
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <p className="text-xl text-[#7A9E98] mb-4 max-w-3xl leading-relaxed">
              Emergency MacBook liquid damage repair for Rivonia clients. Same-day collection. Ultrasonic cleaning and component-level board repair at our Hyde Park workshop, approx 15-20 minutes from Rivonia.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href={buildWhatsAppUrl('LIQ-RIVONIA', 'liquid-damage')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 hover:shadow-[0_0_32px_rgba(15,234,122,0.4)] transition-all" >
      ...
      <section className="py-10 sm:py-20 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-[#E8F4F1] mb-8">What To Do After a Spill, Rivonia Clients</h2>
      ...
      <section className="py-10 sm:py-20 bg-[#0A1A18]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <PricingNote />
          <FAQAccordion items={faqs} title={`MacBook Liquid Damage Repair Rivonia, Common Questions`} />
        </div>
      </section>
      ...
      <section className="py-8 sm:py-16 bg-[#0A1A18]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-[rgba(39,80,77,0.3)] border border-[rgba(15,234,122,0.2)] rounded-3xl p-10">
            <h2 className="text-3xl font-extrabold text-[#E8F4F1] mb-3">Liquid Damage in Rivonia? Act Now.</h2>
            <p className="text-[#7A9E98] mb-6">We collect from Rivonia, Sandton, Paulshof, and Sunninghill.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href={buildWhatsAppUrl('LIQ-RIVONIA', 'liquid-damage')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 transition-all" >
                WhatsApp, Emergency Collection
              </a>
              <a href={`tel:${CONTACT.phoneTel}`} className="inline-flex items-center justify-center gap-2 border border-[rgba(15,234,122,0.35)] text-[#0FEA7A] px-8 py-4 rounded-xl text-lg font-semibold hover:bg-[rgba(15,234,122,0.08)] transition-all">
                <Phone className="w-5 h-5" /> Call {CONTACT.phone}
