...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/liquid-damage/macbook-air', title: 'MacBook Air Liquid Damage Repair', description: 'MacBook Air liquid damage repair in Johannesburg. Emergency guide, Assessment, up-to-3 year warranty. M1, M2, M3 and Intel models. Hyde Park. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
...
export default function MacBookAirLiquidDamagePage() {
  const whatsappLiquidDamage = buildWhatsAppUrl('LIQ-MBA', 'liquid-damage');
  ...
  return (
    <>
      ...
      <section className="py-12 bg-[#0A1A18]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <PricingRange page="/liquid-damage/macbook-air" />
          <PricingNote />
        </div>
      </section>
