...
export const metadata: Metadata = {
  ...
  description: 'MacBook liquid damage repair for Morningside clients. Ultrasonic cleaning, board-level diagnostics, same-day collection from Morningside. Assessment from R599. Call 064 529 5863.',
...
const serviceSchema = {
  ...
  description: 'MacBook liquid damage repair for Morningside clients. Ultrasonic cleaning, component-level repair. Assessment from R599.',
