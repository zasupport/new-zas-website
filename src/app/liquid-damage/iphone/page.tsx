...
export const metadata: Metadata = {
  ...
  description:
    'iPhone liquid damage repair in Johannesburg. All models iPhone 8 through 16 Pro Max. Assessment: R899 ex VAT. Call 064 529 5863.',
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <div className="flex items-center gap-3 mt-4 p-4 bg-[rgba(15,234,122,0.05)] rounded-xl border border-[rgba(15,234,122,0.1)]">
                ...
                <p className="text-[#7A9E98] text-sm">Assessment: R899 ex VAT. warranty on all repairs.</p>
              </div>
            </div>
          </div>
        </div>
