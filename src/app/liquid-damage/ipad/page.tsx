        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <p className="text-xl text-[#7A9E98] mb-6 max-w-3xl leading-relaxed">
              ...
              Assessment: from R599, up-to-3 year warranty. Hyde Park, Johannesburg.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <div className="flex items-center gap-3 p-4 bg-[rgba(15,234,122,0.05)] rounded-xl border border-[rgba(15,234,122,0.1)]">
                ...
                <p className="text-[#7A9E98] text-sm">Assessment: from R599. warranty on all repairs. Hyde Park, Johannesburg.</p>
              </div>
            </div>
          </div>
        </div>
