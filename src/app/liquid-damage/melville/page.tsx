...
export const metadata: Metadata = {
  ...
  description: 'MacBook liquid damage repair for Melville clients. Ultrasonic cleaning, component-level board repair. Assessment from R599. Collection from Melville. No Fix No Fee.',
  alternates: { canonical: 'https://zasupport.com/liquid-damage/melville' },
};

const faults = [
  { title: 'Coffee or Tea Spill', desc: 'The most common liquid damage we see from Melville clients. Coffee contains acids and sugars that accelerate corrosion on the logic board far faster than clean water. Immediate assessment gives the best repair outcome — corrosion spreads hourly once the liquid dries.' },
  { title: 'Rain or Humidity Damage', desc: 'Johannesburg\'s afternoon thunderstorms and summer humidity cause a pattern of damage we see frequently. Rain through an open bag or condensation from rapid temperature changes between air-conditioned offices and outdoor heat in Melville. The damage is progressive and often invisible until symptoms appear days later.' },
  ...
  { title: 'Secondary Component Failure', desc: 'After an initial liquid damage event, other components can fail weeks or months later as corrosion continues to spread. We see Melville clients return after an apparently successful home dry-out only to find additional circuits failing. Professional ultrasonic cleaning removes all corrosion — preventing the cascading failure pattern.' },
];

const faqs = [
  {
    question: 'Do you collect liquid-damaged MacBooks from Melville?',
    answer: 'Yes — same-day collection from Melville. For liquid damage, speed matters. Melville is approximately 8 km from our Hyde Park workshop, roughly 12–18 minutes by car. WhatsApp 064 529 5863 to arrange immediate collection.',
  },
  {
    question: 'How much does MacBook liquid damage repair cost for Melville clients?',
  ...
  {
    question: 'Do you offer No Fix No Fee for liquid damage from Melville?',
    answer: 'Yes. If we cannot repair the board after assessment, you pay only the R599 assessment fee. No Fix No Fee applies to all Melville clients. Collection is included.',
  },
];
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'MacBook Liquid Damage Repair Melville',
  description: 'Ultrasonic cleaning and component-level MacBook liquid damage repair for Melville clients. Assessment from R599.',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Melville', item: 'https://zasupport.com/liquid-damage/melville' },
  ],
};

const faqSchema = buildFaqSchema(faqs);

export default function LiquidDamageMelvillePage() {
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <p className="text-xl text-[#7A9E98] mb-4 max-w-3xl leading-relaxed">
              Ultrasonic cleaning and component-level board repair for liquid-damaged MacBooks from Melville. Coffee, water, rain, condensation — all assessed and repaired at our Hyde Park workshop. Collection from Melville — approximately 8 km, 12–18 minutes by car.
            </p>
            <div className="flex items-center gap-2 text-[#7A9E98] text-sm mb-8">
              <MapPin className="w-4 h-4 text-[#0FEA7A]" />
              <span>Hyde Park, Johannesburg | Assessment from R599 | Same-day collection from Melville</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href={buildWhatsAppUrl('LD-MELVILLE', 'liquid-damage')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 hover:shadow-[0_0_32px_rgba(15,234,122,0.4)] transition-all">
                WhatsApp for Quote
              </a>
      ...
      <section className="py-10 sm:py-20 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-[#E8F4F1] mb-4">Liquid Damage Scenarios We Repair for Melville Clients</h2>
          <p className="text-[#7A9E98] mb-8 leading-relaxed">Melville is approximately 8 km from our Hyde Park workshop. For liquid damage, proximity matters — the sooner the board reaches us, the better the repair outcome. All MacBook models from 2015 onwards are covered. Ultrasonic cleaning and component-level board repair, not board replacement.</p>
      ...
      <section className="py-10 sm:py-20 bg-[#0A1A18]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <FAQAccordion items={faqs} title={`MacBook Liquid Damage Repair Melville — Common Questions`} />
        </div>
      </section>
      ...
      <section className="py-8 sm:py-16 bg-[#0A1A18]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-[rgba(39,80,77,0.3)] border border-[rgba(15,234,122,0.2)] rounded-3xl p-10">
            ...
            <p className="text-[#7A9E98] mb-6">Same-day collection from Melville. Ultrasonic cleaning. Assessment from R599. No Fix No Fee.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href={buildWhatsAppUrl('LD-MELVILLE', 'liquid-damage')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 transition-all">
                WhatsApp for Quote
              </a>
              <a href={`tel:${CONTACT.phoneTel}`} className="inline-flex items-center justify-center gap-2 border border-[rgba(15,234,122,0.35)] text-[#0FEA7A] px-8 py-4 rounded-xl text-lg font-semibold hover:bg-[rgba(15,234,122,0.08)] transition-all">
                <Phone className="w-5 h-5" /> Call {CONTACT.phone}
