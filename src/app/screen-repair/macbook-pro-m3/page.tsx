...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/screen-repair/macbook-pro-m3', title: 'MacBook Pro M3 Screen Repair Johannesburg [2026] | ZA Support', description: 'MacBook Pro M3 screen repair in Johannesburg. Liquid Retina XDR mini-LED specialists. ProMotion, True Tone, backlight IC. No Fix No Fee. Hyde Park workshop.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
