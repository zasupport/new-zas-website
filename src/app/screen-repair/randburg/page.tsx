...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/screen-repair/randburg', title: 'MacBook Screen Repair Randburg | ZA Support Hyde Park', description: 'MacBook screen repair for Randburg clients. Cracked displays, backlight failure, and LCD faults repaired at our Hyde Park workshop with a local collection and return service. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
