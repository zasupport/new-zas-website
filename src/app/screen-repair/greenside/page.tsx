...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/screen-repair/greenside', title: 'MacBook Screen Repair Greenside | ZA Support Hyde Park', description: 'MacBook screen repair for Greenside clients. Cracked display, pressure marks, flickering, backlight failure. Collection from Greenside. Assessment.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
  title: 'MacBook Screen Repair Greenside | ZA Support Hyde Park',
  description: 'MacBook screen repair for Greenside clients. Cracked display, pressure marks, flickering, backlight failure. Collection from Greenside. Assessment.',
  alternates: { canonical: 'https://zasupport.com/screen-repair/greenside' },
};
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'MacBook Screen Repair Greenside',
  description: 'MacBook screen repair for Greenside clients. Cracked display, pressure marks, backlight failure. Assessment.',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Greenside', item: 'https://zasupport.com/screen-repair/greenside' },
  ],
};

const faqSchema = buildFaqSchema(faqs);

export default function ScreenRepairGreensidePage() {
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <p className="text-xl text-[#7A9E98] mb-4 max-w-3xl leading-relaxed">
              MacBook screen repair for Greenside clients. Cracked display, pressure marks, flickering, backlight failure, and display coating damage. Assessment at our Hyde Park workshop. Collection from Greenside, approximately 5 km, 8-12 minutes by car.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href={buildWhatsAppUrl('SR-GREENSIDE', 'screen')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 hover:shadow-[0_0_32px_rgba(15,234,122,0.4)] transition-all">
                WhatsApp for Quote
              </a>
      ...
      <section className="py-8 sm:py-16 bg-[#0A1A18]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-[rgba(39,80,77,0.3)] border border-[rgba(15,234,122,0.2)] rounded-3xl p-10">
            ...
            <p className="text-[#7A9E98] mb-6">Collecting from Greenside. Same-day available. No Fix No Fee.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href={buildWhatsAppUrl('SR-GREENSIDE', 'screen')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 transition-all">
                WhatsApp for Quote
              </a>
              <a href={`tel:${CONTACT.phoneTel}`} className="inline-flex items-center justify-center gap-2 border border-[rgba(15,234,122,0.35)] text-[#0FEA7A] px-8 py-4 rounded-xl text-lg font-semibold hover:bg-[rgba(15,234,122,0.08)] transition-all">
                <Phone className="w-5 h-5" /> Call {CONTACT.phone}
