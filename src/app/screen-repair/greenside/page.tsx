...
export const metadata: Metadata = {
  ...
  description: 'MacBook screen repair for Greenside clients. Cracked display, pressure marks, flickering, backlight failure. Collection from Greenside. Assessment from R599.',
...
const serviceSchema = {
  ...
  description: 'MacBook screen repair for Greenside clients. Cracked display, pressure marks, backlight failure. Assessment from R599.',
