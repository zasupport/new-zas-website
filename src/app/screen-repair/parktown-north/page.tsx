...
const serviceSchema = {
  ...
  description: 'MacBook screen repair for Parktown North clients. Cracked display, pressure marks, backlight failure. Assessment.',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <p className="text-xl text-[#7A9E98] mb-4 max-w-3xl leading-relaxed">
              MacBook screen repair for Parktown North clients. Cracked display, pressure marks, flickering, backlight failure, and display coating damage. Assessment at our Hyde Park workshop. Collection from Parktown North, approximately 6 km, 10-12 minutes by car.
            </p>
