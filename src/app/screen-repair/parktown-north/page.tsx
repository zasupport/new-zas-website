...
export const metadata: Metadata = {
  ...
  description: 'MacBook screen repair for Parktown North clients. Cracked display, pressure marks, flickering, backlight failure. Collection from Parktown North. Assessment from R599.',
...
const faqs = [
  {
    question: 'Do you collect MacBooks for screen repair from Parktown North?',
    answer: 'Yes. Parktown North is approximately 6 km from our Hyde Park workshop — roughly 10–12 minutes by car. We collect, assess the display fault, and provide a written quote before proceeding. WhatsApp 064 529 5863 to arrange.',
  },
  {
    question: 'How much does MacBook screen repair cost for Parktown North clients?',
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'MacBook Screen Repair Parktown North',
  description: 'MacBook screen repair for Parktown North clients. Cracked display, pressure marks, backlight failure. Assessment from R599.',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Parktown North', item: 'https://zasupport.com/screen-repair/parktown-north' },
  ],
};

const faqSchema = buildFaqSchema(faqs);

export default function ScreenRepairParktownNorthPage() {
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <p className="text-xl text-[#7A9E98] mb-4 max-w-3xl leading-relaxed">
              MacBook screen repair for Parktown North clients. Cracked display, pressure marks, flickering, backlight failure, and display coating damage. Assessment from R599 at our Hyde Park workshop. Collection from Parktown North — approximately 6 km, 10–12 minutes by car.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href={buildWhatsAppUrl('SR-PARKTOWNNORTH', 'screen')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 hover:shadow-[0_0_32px_rgba(15,234,122,0.4)] transition-all">
                WhatsApp for Quote
              </a>
      ...
      <section className="py-10 sm:py-20 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-[#E8F4F1] mb-4">MacBook Screen Faults We Repair for Parktown North Clients</h2>
          <p className="text-[#7A9E98] mb-8 leading-relaxed">Parktown North is approximately 6 km from our Hyde Park workshop. All MacBook models from 2015 onwards are covered — Retina, Liquid Retina, and Liquid Retina XDR displays. Every fault is assessed before quoting, and many display issues can be resolved at board level without replacing the full screen assembly.</p>
      ...
      <section className="py-10 sm:py-20 bg-[#0A1A18]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <FAQAccordion items={faqs} title={`MacBook Screen Repair Parktown North — Common Questions`} />
        </div>
      </section>
      ...
      <section className="py-8 sm:py-16 bg-[#0A1A18]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-[rgba(39,80,77,0.3)] border border-[rgba(15,234,122,0.2)] rounded-3xl p-10">
            ...
            <p className="text-[#7A9E98] mb-6">Collecting from Parktown North. Same-day available. No Fix No Fee.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href={buildWhatsAppUrl('SR-PARKTOWNNORTH', 'screen')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 transition-all">
                WhatsApp for Quote
              </a>
              <a href={`tel:${CONTACT.phoneTel}`} className="inline-flex items-center justify-center gap-2 border border-[rgba(15,234,122,0.35)] text-[#0FEA7A] px-8 py-4 rounded-xl text-lg font-semibold hover:bg-[rgba(15,234,122,0.08)] transition-all">
                <Phone className="w-5 h-5" /> Call {CONTACT.phone}
