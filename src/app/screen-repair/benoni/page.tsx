...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/screen-repair/benoni', title: 'MacBook Screen Repair Benoni | ZA Support Hyde Park', description: 'MacBook screen repair for Benoni clients. Cracked displays, backlight failure, LCD faults. We collect from Benoni and repair at our Hyde Park workshop. Assessment. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
...
const faqs = [
  {
    question: 'Do you collect MacBooks for screen repair from Benoni?',
    answer: 'Yes. We offer collection and return for Benoni clients. Your MacBook is collected from Benoni, Lakefield, and the East Rand suburban corridor, repaired at our Hyde Park workshop approximately 40 minutes away, and returned once complete.',
  },
  {
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'MacBook Screen Repair Benoni',
  description: 'MacBook screen repair for Benoni clients. Cracked displays, backlight, LCD faults. Collection from Benoni.',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Benoni', item: 'https://zasupport.com/screen-repair/benoni' },
  ],
};

const faqSchema = buildFaqSchema(faqs);

export default function ScreenRepairBenoniPage() {
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href={buildWhatsAppUrl('SCR-BENONI', 'screen-repair')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 hover:shadow-[0_0_32px_rgba(15,234,122,0.4)] transition-all">
                💬 WhatsApp for Quote
              </a>
      ...
      <section className="py-10 sm:py-20 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <FAQAccordion items={faqs} title="Screen Repair Benoni, Common Questions" />
        </div>
      </section>
