...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/screen-repair/macbook-air-m3', title: 'MacBook Air M3 Screen Repair Johannesburg [2026] | ZA Support', description: 'MacBook Air M3 screen repair in Johannesburg. Liquid Retina display specialists. Cracked screen, pressure marks, backlight fault. No Fix No Fee. Hyde Park workshop.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
