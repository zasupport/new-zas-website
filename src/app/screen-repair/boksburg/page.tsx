...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/screen-repair/boksburg', title: 'MacBook Screen Repair Boksburg | ZA Support Hyde Park', description: 'MacBook screen repair for Boksburg clients. Cracked displays, backlight failure, LCD faults. We collect from Boksburg and repair at our Hyde Park workshop. Assessment. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
  title: 'MacBook Screen Repair Boksburg | ZA Support Hyde Park',
  description:
    'MacBook screen repair for Boksburg clients. Cracked displays, backlight failure, LCD faults. We collect from Boksburg and repair at our Hyde Park workshop. Assessment. Call 064 529 5863.',
  alternates: { canonical: 'https://zasupport.com/screen-repair/boksburg' },
};
...
const faqs = [
  {
    question: 'Do you collect MacBooks for screen repair from Boksburg?',
    answer: 'Yes. We offer collection and return for Boksburg clients. Your MacBook is collected from Boksburg, Vosloorus, and the East Rand industrial and residential belt, repaired at our Hyde Park workshop approximately 35 minutes away, and returned once complete.',
  },
  {
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'MacBook Screen Repair Boksburg',
  description: 'MacBook screen repair for Boksburg clients. Cracked displays, backlight, LCD faults. Collection from Boksburg.',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Boksburg', item: 'https://zasupport.com/screen-repair/boksburg' },
  ],
};

const faqSchema = buildFaqSchema(faqs);

export default function ScreenRepairBoksburgPage() {
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[#E8F4F1] leading-tight mb-6">
              MacBook Screen Repair Boksburg
              <br /><span className="text-[#0FEA7A]">, Display Specialists</span>
            </h1>
            <p className="text-xl text-[#7A9E98] mb-4 max-w-3xl leading-relaxed">
              Screen repairs for Boksburg residents and businesses. Cracked displays, backlight failure, display lines, and LCD faults. We collect from Boksburg and repair at our Hyde Park workshop. Assessment.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href={buildWhatsAppUrl('SCR-BOKSBURG', 'screen-repair')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 hover:shadow-[0_0_32px_rgba(15,234,122,0.4)] transition-all">
                💬 WhatsApp for Quote
              </a>
      ...
      <section className="py-10 sm:py-20 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <FAQAccordion items={faqs} title="Screen Repair Boksburg, Common Questions" />
        </div>
      </section>
      ...
      <section className="py-8 sm:py-16 bg-[#0A1A18]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
            {[
              { label: "Benoni", href: "/screen-repair/benoni" },
      ...
      <section className="py-8 sm:py-16 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-[rgba(39,80,77,0.3)] border border-[rgba(15,234,122,0.2)] rounded-3xl p-10">
            <h2 className="text-3xl font-extrabold text-[#E8F4F1] mb-3">Cracked Screen in Boksburg? Assessment.</h2>
            <p className="text-[#7A9E98] mb-6">We collect from Boksburg. Assessment. 12-month warranty.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href={buildWhatsAppUrl('SCR-BOKSBURG', 'screen-repair')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 transition-all">
                💬 WhatsApp for Quote
              </a>
              <a href={`tel:${CONTACT.phoneTel}`} className="inline-flex items-center justify-center gap-2 border border-[rgba(15,234,122,0.35)] text-[#0FEA7A] px-8 py-4 rounded-xl text-lg font-semibold hover:bg-[rgba(15,234,122,0.08)] transition-all">
                <Phone className="w-5 h-5" /> Call {CONTACT.phone}
      ...
      <section className="py-12 bg-[#0A1A18]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <PricingRange page="/screen-repair/boksburg" />
          <PricingNote />
        </div>
      </section>
