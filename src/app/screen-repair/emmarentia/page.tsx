...
export const metadata: Metadata = {
  ...
  description: 'MacBook screen repair for Emmarentia clients. Cracked display, pressure marks, flickering, backlight failure. Collection from Emmarentia. Assessment from R599.',
...
const serviceSchema = {
  ...
  description: 'MacBook screen repair for Emmarentia clients. Cracked display, pressure marks, backlight failure. Assessment from R599.',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <p className="text-xl text-[#7A9E98] mb-4 max-w-3xl leading-relaxed">
              MacBook screen repair for Emmarentia clients. Cracked display, pressure marks, flickering, backlight failure, and display coating damage. Assessment from R599 at our Hyde Park workshop. Collection from Emmarentia — approximately 6 km, 10–12 minutes by car.
            </p>
