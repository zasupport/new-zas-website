...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/screen-repair/macbook-pro', title: 'MacBook Pro Screen Repair Johannesburg [2026] | ZA Support', description: 'MacBook Pro screen repair in Johannesburg. Retina, Touch Bar, Liquid Retina XDR. Flexgate fix, backlight IC repair. Assessment. Hyde Park workshop.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
