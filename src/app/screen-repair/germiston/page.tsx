...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/screen-repair/germiston', title: 'MacBook Screen Repair Germiston | ZA Support Hyde Park', description: 'MacBook screen repair for Germiston clients. Cracked displays, backlight failure, LCD faults. We collect from Germiston and repair at our Hyde Park workshop. Assessment. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
  title: 'MacBook Screen Repair Germiston | ZA Support Hyde Park',
  description:
    'MacBook screen repair for Germiston clients. Cracked displays, backlight failure, LCD faults. We collect from Germiston and repair at our Hyde Park workshop. Assessment. Call 064 529 5863.',
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <p className="text-xl text-[#7A9E98] mb-4 max-w-3xl leading-relaxed">
              Screen repairs for Germiston residents and businesses. Cracked displays, backlight failure, display lines, and LCD faults. We collect from Germiston and repair at our Hyde Park workshop. Assessment.
            </p>
      ...
      <section className="py-8 sm:py-16 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-[rgba(39,80,77,0.3)] border border-[rgba(15,234,122,0.2)] rounded-3xl p-10">
            <h2 className="text-3xl font-extrabold text-[#E8F4F1] mb-3">Cracked Screen in Germiston? Assessment.</h2>
            <p className="text-[#7A9E98] mb-6">We collect from Germiston. Assessment. 12-month warranty.</p>
      ...
      <section className="py-12 bg-[#0A1A18]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <PricingRange page="/screen-repair/germiston" />
          <PricingNote />
        </div>
      </section>
