...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/screen-repair/kempton-park', title: 'MacBook Screen Repair Kempton Park | ZA Support Hyde Park', description: 'MacBook screen repair for Kempton Park clients near OR Tambo. Cracked displays, backlight faults, and LCD damage. We collect from Kempton Park and repair at our Hyde Park workshop. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
  title: 'MacBook Screen Repair Kempton Park | ZA Support Hyde Park',
  description:
    'MacBook screen repair for Kempton Park clients near OR Tambo. Cracked displays, backlight faults, and LCD damage. We collect from Kempton Park and repair at our Hyde Park workshop. Call 064 529 5863.',
  alternates: { canonical: 'https://zasupport.com/screen-repair/kempton-park' },
};
...
const faults = [
  ...
  { title: 'Water Damage to Screen', desc: 'Liquid ingress behind the display causes streaks, dark patches, or pressure marks. Panel replacement carried out after a full liquid damage assessment.' },
...
const faqs = [
  {
    question: 'Do you collect MacBooks from Kempton Park for screen repairs?',
    answer: 'Yes. We offer a collection and return service for Kempton Park clients. Your MacBook is collected from your home, office, or business near the CBD or OR Tambo area, repaired at our Hyde Park workshop approximately 30 minutes away, and returned once the work is complete. Contact us on WhatsApp or by phone to arrange a convenient collection time.',
  },
  {
  ...
  },
  {
    ...
    answer: 'In most cases, yes. A display replacement on an otherwise functional MacBook is cost-effective compared to a new machine. We see many Kempton Park clients running solid Intel MacBooks that simply need a new display. If the logic board is healthy and the battery has reasonable capacity, a screen repair is the right call. We will tell you honestly if the machine is not worth repairing.',
  },
  {
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'MacBook Screen Repair Kempton Park',
  description: 'MacBook screen repair and display replacement for Kempton Park clients near OR Tambo. Collection from Kempton Park, repair at Hyde Park workshop. Cracked screens, backlight, and display faults.',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Kempton Park', item: 'https://zasupport.com/screen-repair/kempton-park' },
  ],
};

const faqSchema = buildFaqSchema(faqs);

export default function ScreenRepairKemptonParkPage() {
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <div className="flex items-center gap-2 text-[#7A9E98] text-sm mb-8">
              ...
              <span>We collect from Kempton Park and repair at our Hyde Park workshop, approx. 30 min drive</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href={buildWhatsAppUrl('SCR-KEMPTON-PARK-HERO', 'screen-repair')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 hover:shadow-[0_0_32px_rgba(15,234,122,0.4)] transition-all">
                WhatsApp for Quote
              </a>
      ...
      <section className="py-8 sm:py-16 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-[#E8F4F1] mb-6">
            MacBook Screen Repair for Kempton Park Residents and Businesses
          </h2>
      ...
      <section className="py-10 sm:py-20 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-[#E8F4F1] mb-8">
            Our Screen Repair Process for Kempton Park Clients
          </h2>
      ...
      <section className="py-10 sm:py-20 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <FAQAccordion items={faqs} title="MacBook Screen Repair Kempton Park, Common Questions" />
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            {[
              ...
              { label: 'Logic Board Kempton Park', href: '/logic-board-repair/kempton-park' },
            ].map((area) => (
