...
export const metadata: Metadata = {
  ...
  description:
    'MacBook Pro M2 screen repair in Johannesburg from R4,199. Liquid Retina & XDR display specialists. Backlight IC, display cable, True Tone. No Fix No Fee. Hyde Park workshop.',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 p-5 rounded-xl border border-[rgba(15,234,122,0.15)] bg-[rgba(15,234,122,0.04)] flex items-start gap-4">
            ...
            <p className="text-[#7A9E98] text-sm leading-relaxed">
              Every repair is quoted before work begins. Our No Fix No Fee policy means that if we cannot resolve your MacBook Pro M2 screen fault, an assessment fee of R599 applies and your machine is returned exactly as we received it. Up-to-3 year warranty on all completed screen repairs.
            </p>
          </div>
        </div>
      </section>
