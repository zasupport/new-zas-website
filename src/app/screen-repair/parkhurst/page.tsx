...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/screen-repair/parkhurst', title: 'MacBook Screen Repair Parkhurst | ZA Support Hyde Park', description: 'MacBook screen repair for Parkhurst clients. Cracked displays, backlight failure, LCD faults. We collect from 4th Avenue, Parkhurst and repair at our Hyde Park workshop. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
