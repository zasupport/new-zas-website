...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://zasupport.com/screen-repair/roodepoort' },
};
...
const faqs = [
  {
    question: 'Do you collect MacBooks for screen repair from Roodepoort?',
    answer: 'Yes. We offer collection and return for Roodepoort clients. Your MacBook is collected from Roodepoort, Florida, and the West Rand business corridor, repaired at our Hyde Park workshop approximately 32 minutes away, and returned once complete.',
  },
  {
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'MacBook Screen Repair Roodepoort',
  description: 'MacBook screen repair for Roodepoort clients. Cracked displays, backlight, LCD faults. Collection from Roodepoort.',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Roodepoort', item: 'https://zasupport.com/screen-repair/roodepoort' },
  ],
};

const faqSchema = buildFaqSchema(faqs);

export default function ScreenRepairRoodepoortPage() {
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <p className="text-xl text-[#7A9E98] mb-4 max-w-3xl leading-relaxed">
              Screen repairs for Roodepoort residents and businesses. Cracked displays, backlight failure, display lines, and LCD faults. We collect from Roodepoort and repair at our Hyde Park workshop. Assessment.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href={buildWhatsAppUrl('SCR-ROODEPOO', 'screen-repair')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 hover:shadow-[0_0_32px_rgba(15,234,122,0.4)] transition-all">
                💬 WhatsApp for Quote
              </a>
      ...
      <section className="py-8 sm:py-16 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-[rgba(39,80,77,0.3)] border border-[rgba(15,234,122,0.2)] rounded-3xl p-10">
            <h2 className="text-3xl font-extrabold text-[#E8F4F1] mb-3">Cracked Screen in Roodepoort? Assessment.</h2>
            <p className="text-[#7A9E98] mb-6">We collect from Roodepoort. Assessment. 12-month warranty.</p>
      ...
      <section className="py-12 bg-[#0A1A18]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <PricingRange page="/screen-repair/roodepoort" />
          <PricingNote />
        </div>
      </section>
