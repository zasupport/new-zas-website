...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/screen-repair/houghton', title: 'MacBook Screen Repair Houghton | ZA Support Hyde Park', description: 'MacBook screen repair for Houghton clients. Cracked displays, backlight failure, LCD faults. We collect from Houghton and repair at our Hyde Park workshop, 4km away. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
