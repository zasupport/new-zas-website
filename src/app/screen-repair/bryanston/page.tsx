...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/screen-repair/bryanston', title: 'MacBook Screen Repair Bryanston | ZA Support Hyde Park', description: 'MacBook screen repair for Bryanston clients. Cracked screens, backlight failure, and display faults repaired at our Hyde Park workshop. Collection service available. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
