...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/screen-repair/paulshof', title: 'MacBook Screen Repair Paulshof | ZA Support Hyde Park', description: 'MacBook screen repair for Paulshof clients. Cracked displays, backlight failure, LCD faults. We collect from Paulshof and repair at our Hyde Park workshop. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
