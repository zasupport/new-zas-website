...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/screen-repair/centurion', title: 'MacBook Screen Repair Centurion | ZA Support Hyde Park', description: 'MacBook screen repair for Centurion clients near Centurion Mall and Hendrik Verwoerd Drive tech offices. Cracked screens, backlight faults, and LCD damage. Collection service available. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
  title: 'MacBook Screen Repair Centurion | ZA Support Hyde Park',
  description:
    'MacBook screen repair for Centurion clients near Centurion Mall and Hendrik Verwoerd Drive tech offices. Cracked screens, backlight faults, and LCD damage. Collection service available. Call 064 529 5863.',
  alternates: { canonical: 'https://zasupport.com/screen-repair/centurion' },
};
...
const faqs = [
  {
    question: 'Do you collect MacBooks from Centurion for screen repairs?',
    answer: 'Yes. We collect from Centurion and return the repaired MacBook to you. Whether you are based near Centurion Mall, along Hendrik Verwoerd Drive, or in residential areas such as Lyttelton or Wierda Park, we arrange collection at a time that suits you. The repair is carried out at our Hyde Park workshop, approximately 40 minutes south via the N1.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Yes. We collect from commercial premises throughout Centurion, including office parks along Hendrik Verwoerd Drive and surrounding business nodes. Contact us on WhatsApp to arrange a collection that works around your business hours. We can collect from a reception desk or security gate.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Yes. We work with small businesses and practices throughout Centurion. If you have multiple machines needing repair, contact us on WhatsApp and we can arrange a batch collection and prioritised turnaround. We can also provide a written service record and warranty documentation per machine for business records.',
  },
];
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'MacBook Screen Repair Centurion',
  description: 'MacBook screen repair and display replacement for Centurion clients. Collection from Centurion Mall area and Hendrik Verwoerd Drive, repair at Hyde Park workshop. Cracked screens, backlight, and display faults.',
  provider: LOCAL_BUSINESS_PROVIDER,
  areaServed: [
    { '@type': 'City', name: 'Pretoria' },
    { '@type': 'Neighborhood', name: 'Centurion' },
  ],
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Centurion', item: 'https://zasupport.com/screen-repair/centurion' },
  ],
};

const faqSchema = buildFaqSchema(faqs);

export default function ScreenRepairCenturionPage() {
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <div className="flex items-center gap-2 text-[#7A9E98] text-sm mb-8">
              ...
              <span>We collect from Centurion and repair at our Hyde Park workshop, approx. 40 min via the N1</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href={buildWhatsAppUrl('SCR-CENTURION-HERO', 'screen-repair')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 hover:shadow-[0_0_32px_rgba(15,234,122,0.4)] transition-all">
                WhatsApp for Quote
              </a>
      ...
      <section className="py-8 sm:py-16 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-[#E8F4F1] mb-6">
            MacBook Screen Repair for Centurion Residents and Businesses
          </h2>
          <div className="space-y-4 text-[#7A9E98] leading-relaxed">
            ...
            <p>
              If you are based near Centurion Mall or on the Hendrik Verwoerd corridor and your MacBook display has failed, contact us on WhatsApp and we will arrange a collection that fits around your schedule.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-10 sm:py-20 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-[#E8F4F1] mb-8">
            Our Screen Repair Process for Centurion Clients
          </h2>
          <div className="space-y-6">
            {[
              ...
              { step: '05', title: 'Return to Centurion', desc: 'Display tested across brightness levels and colour profiles. MacBook returned to your Centurion address with a written warranty.' },
            ].map(({ step, title, desc }) => (
      ...
      <section className="py-10 sm:py-20 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <FAQAccordion items={faqs} title="MacBook Screen Repair Centurion, Common Questions" />
        </div>
      </section>
      ...
      <section className="py-8 sm:py-16 bg-[#0A1A18]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            {[
              { label: 'Screen Repair Pretoria', href: '/screen-repair/pretoria' },
