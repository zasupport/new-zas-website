        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <p className="text-xl text-[#7A9E98] mb-4 max-w-3xl leading-relaxed">
              Screen repairs for Edenvale residents and businesses. Cracked displays, backlight failure, display lines, and LCD faults. We collect from Edenvale and repair at our Hyde Park workshop. Assessment.
            </p>
      ...
      <section className="py-8 sm:py-16 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-[rgba(39,80,77,0.3)] border border-[rgba(15,234,122,0.2)] rounded-3xl p-10">
            <h2 className="text-3xl font-extrabold text-[#E8F4F1] mb-3">Cracked Screen in Edenvale? Assessment.</h2>
            <p className="text-[#7A9E98] mb-6">We collect from Edenvale. Assessment. 12-month warranty.</p>
