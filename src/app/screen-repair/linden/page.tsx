...
const faqs = [
  {
    question: 'Do you collect MacBooks for screen repair from Linden?',
    answer: 'Yes. Linden is approximately 7 km from our Hyde Park workshop, roughly 12-15 minutes by car. We collect, assess the display fault, and provide a written quote before proceeding. WhatsApp 064 529 5863 to arrange.',
  },
  {
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Linden', item: 'https://zasupport.com/screen-repair/linden' },
  ],
};

const faqSchema = buildFaqSchema(faqs);

export default function ScreenRepairLindenPage() {
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href={buildWhatsAppUrl('SR-LINDEN', 'screen')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 hover:shadow-[0_0_32px_rgba(15,234,122,0.4)] transition-all">
                WhatsApp for Quote
              </a>
      ...
      <section className="py-10 sm:py-20 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-[#E8F4F1] mb-4">MacBook Screen Faults We Repair for Linden Clients</h2>
          <p className="text-[#7A9E98] mb-8 leading-relaxed">Linden is approximately 7 km from our Hyde Park workshop. All MacBook models from 2015 onwards are covered, Retina, Liquid Retina, and Liquid Retina XDR displays. Every fault is assessed before quoting, and many display issues can be resolved at board level without replacing the full screen assembly.</p>
      ...
      <section className="py-10 sm:py-20 bg-[#0A1A18]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <PricingNote />
          <FAQAccordion items={faqs} title={`MacBook Screen Repair Linden, Common Questions`} />
        </div>
      </section>
