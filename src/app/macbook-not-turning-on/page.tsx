...
export const metadata: Metadata = {
  title: 'MacBook Not Turning On Johannesburg | Free Assessment',
  description:
    'MacBook won\'t turn on? Free same-day diagnosis in Johannesburg. 8 out of 10 Macs that won\'t power on are repairable. No Fix No Fee. Hyde Park. Call 064 529 5863.',
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'In most cases, yes. For battery failures, surge damage, and backlight faults, the storage drive is usually completely intact — your data is unaffected. For liquid damage and logic board failures, data recovery is typically possible even if the MacBook itself cannot be economically repaired, as we can often read the storage chip directly. We will give you an honest assessment of data recovery prospects during the free diagnostic.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Free diagnostic: completed within 24 hours of drop-off. Battery replacement: same day or next day. Firmware restore: 24–48 hours. Charging IC repair: 2–3 business days. Logic board component repair: 1–4 business days depending on complexity. Liquid damage with corrosion: 2–5 business days. We confirm the exact timeframe at the diagnostic stage and update you at each step. No machine sits waiting without communication.',
  },
  {
      ...
      <main className="bg-[#0A1A18] min-h-screen">
        ...
        <section className="hero-gradient grid-overlay relative overflow-hidden pt-24 pb-20 sm:pt-32 sm:pb-28">
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-xl sm:text-2xl text-[#7A9E98] mb-4 max-w-3xl leading-relaxed">
              ...
              Free diagnosis — no charge, no obligation.
            </p>
        ...
        <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="mb-12">
            ...
            <p className="text-[#7A9E98] text-lg max-w-2xl">
              ...
              If none of these work — bring it to us. Free assessment, no obligation.
            </p>
          </div>
          ...
          <div className="mt-8 bg-[rgba(15,234,122,0.05)] border border-[#0FEA7A]/20 rounded-2xl p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-[#7A9E98]">Free assessment at our Hyde Park workshop. Takes 30 minutes. No charge regardless of outcome.</p>
            </div>
            <a
              href={`https://wa.me/27790539964?text=Hi%20ZA%20Support%2C%20my%20MacBook%20won%27t%20turn%20on%20%E2%80%94%20need%20help`}
              target="_blank"
              ...
              {[
                {
                  ...
                  detail: 'Drop off at Hyde Park or arrange collection. We test the power circuit, battery, logic board rails, and charging path. Completed within 24 hours. You pay nothing at this stage.',
        ...
        <section className="bg-[rgba(15,234,122,0.04)] border-t border-[#0FEA7A]/15">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
            <div className="inline-flex items-center gap-2 bg-[#0FEA7A]/10 border border-[#0FEA7A]/20 rounded-full px-4 py-2 mb-6">
              <div className="w-2 h-2 rounded-full bg-[#0FEA7A] animate-pulse" />
              <span className="text-[#0FEA7A] text-sm font-semibold">Free Assessment — No Obligation</span>
            </div>
