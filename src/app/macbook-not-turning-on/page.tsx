...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/macbook-not-turning-on', title: 'MacBook Not Turning On Johannesburg | Assessment', description: 'MacBook won\'t turn on? Same-day assessment in Johannesburg. 8 out of 10 Macs that won\'t power on are repairable. Assessment. Hyde Park. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
