...
const faqs = [
  ...
  { question: 'How much does MacBook charging repair cost in South Africa?', answer: 'Costs vary by fault type. A new genuine charger, USB-C port cleaning, charging IC replacement (CD3215, CD3217, ISL9240), and battery replacement are each priced according to the specific fault and model. ZA Support provides a written quote after the assessment, Assessment applies.' },
  ...
  { question: 'Can you repair a MacBook charging port?', answer: 'Yes. For USB-C MacBooks, the port itself is soldered to the logic board and can be replaced if physically damaged. More often, the fault is the USB-C controller IC (CD3215 or CD3217) behind the port rather than the port itself. For older MagSafe MacBooks, the DC-in board is a separate module that clips in and is straightforward to replace. ZA Support diagnoses the exact fault during the assessment.' },
  { question: 'Is it safe to use a third-party MacBook charger?', answer: 'We strongly advise against cheap unbranded chargers. They often lack proper voltage regulation, overheat, and can damage the USB-C controller IC on the logic board. If you need an alternative to Apple, stick to reputable brands like Anker or Belkin that are USB-PD certified. In South Africa, counterfeit Apple chargers are common, if the price seems too good, it probably is. A cheap counterfeit charger that kills your charging IC is no saving.' },
  { question: 'How long does charging IC repair take?', answer: 'At ZA Support, the assessment typically takes 24 to 48 hours. Once you approve the written quote, charging IC repair (CD3215, CD3217, ISL9240) is completed within 3 to 5 business days. The repair includes a 12-month warranty on parts and labour. We collect from Sandton, Rosebank, Fourways, Bryanston, Midrand, Randburg, and surrounding Johannesburg suburbs.' },
];
...
const steps = [
  ...
  { name: 'Get a professional assessment', text: 'If you have worked through steps 1 to 9 without success, the fault requires board-level diagnosis. At ZA Support, we use thermal imaging and micro-soldering stations to pinpoint the exact failed component, whether that is a blown fuse, a shorted capacitor, a dead charging IC, or a damaged battery connector. Our assessment includes a full written report identifying the fault, a fixed-price repair quote, and our Assessment guarantee. We collect from Sandton, Rosebank, Fourways, Bryanston, Midrand, Randburg, and surrounding Johannesburg suburbs.' },
];

const costGuide = [
  { repair: 'New genuine Apple charger (USB-C / MagSafe)', cost: 'Contact for pricing' },
  { repair: 'USB-C / MagSafe port cleaning', cost: 'Contact for pricing' },
  { repair: 'MagSafe DC-in board replacement', cost: 'Contact for pricing' },
  { repair: 'USB-C controller IC repair (CD3215 / CD3217)', cost: 'Contact for pricing' },
  { repair: 'Charger IC repair (ISL9240)', cost: 'Contact for pricing' },
  { repair: 'Battery replacement (MacBook Air)', cost: 'Contact for pricing' },
  { repair: 'Battery replacement (MacBook Pro)', cost: 'Contact for pricing' },
  { repair: 'Full logic board diagnosis (assessment fee)', cost: 'Contact for pricing' },
];
...
const serviceSchema = {
  ...
  description: 'MacBook charging fault diagnosis and repair in Johannesburg. USB-C controller, charger IC, MagSafe, and battery repairs. Assessment.',
    ...
    <>
          ...
          <div className="space-y-4">
            <div className="glass-card p-5">
              ...
              <p className="text-[#7A9E98] text-sm leading-relaxed">
                These Texas Instruments chips handle USB-C power negotiation on every MacBook from 2016 onwards. They communicate with the charger to agree on voltage (5V, 9V, 15V, or 20V) and current. A surge or liquid damage kills the negotiation, so the charger never delivers power even though the cable is physically connected. Symptoms: no charging from one or both USB-C ports, intermittent charging, or the Mac drawing power but not negotiating the correct wattage. The CD3217 is the newer variant found in M1 and later machines.
              </p>
            </div>
            <div className="glass-card p-5">
      ...
      <section className="py-10 sm:py-20 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-[#7A9E98] mb-8 leading-relaxed">
            Prices depend on the specific fault and MacBook model. Apple charges many times more for a full logic board replacement because they do not repair at component level. ZA Support repairs only the failed component, which is a fraction of the cost. All repairs below include our 12-month warranty.
          </p>
          ...
          <p className="text-[#7A9E98] text-sm mt-6">
            All repairs are quoted after the assessment applies, if we cannot fix it, you pay nothing beyond the assessment fee. Prices valid as of 2026 and subject to model-specific variation.
          </p>
          <PricingNote />
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-[rgba(39,80,77,0.3)] border border-[rgba(15,234,122,0.2)] rounded-3xl p-10">
            ...
            <p className="text-[#7A9E98] mb-6">
              Assessment. 12-month warranty on all charging repairs. Collection from Sandton, Rosebank, Fourways, Bryanston, Midrand, and Randburg.
            </p>
