...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/iphone-repair/charging', title: 'iPhone Not Charging, Repair Johannesburg | ZA Support', description: 'iPhone not charging? Lightning and USB-C port repair in Johannesburg. All models iPhone 12 through 16 Pro Max. Same-day available. up-to-3 year warranty. Hyde Park.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
...
const processSteps = [
  { step: '1', title: 'Assessment', desc: 'Bring your iPhone in or WhatsApp us. We first test your cable and adapter, if those are the problem, only our assessment fee applies. Then we inspect the port.' },
...
const faqs = [
  {
    ...
    answer:
      'We provide an assessment fee and fixed-price quote before any work. The cost depends on whether it is a simple lint clean, port replacement, or corrosion repair.',
  },
  {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              ...
              { title: 'iPhone Back Glass Repair', href: '/iphone-repair/back-glass', label: 'Assessment' },
            ].map((item) => (
