...
const processSteps = [
  { step: '1', title: 'Assessment', desc: 'Bring your iPhone in or WhatsApp us a sample photo. We identify whether the fault is the lens, the module, or a software issue before quoting.' },
...
const faqs = [
  {
    ...
    answer:
      'iPhone camera repair pricing depends on the repair type and model. We provide an assessment fee and written fixed-price quote before any work begins.',
  },
  {
...
const whatsappUrl = buildWhatsAppUrl('IPH-CAM', 'iphone-repair');
      ...
      <section className="py-10 sm:py-20 bg-[#0A1A18]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-[#7A9E98] mb-8 max-w-2xl">
            We provide a written fixed-price quote after an assessment. Send us a photo of your camera fault
      ...
      <section className="py-10 sm:py-20 bg-[#111C1A]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-[#7A9E98] mb-10 max-w-2xl">
            ...
            your camera fault is hardware or software, we check first.
          </p>
