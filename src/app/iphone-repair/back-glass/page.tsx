...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/iphone-repair/back-glass', title: 'iPhone Back Glass Repair Johannesburg | ZA Support', description: 'iPhone back glass repair in Johannesburg. Cracked rear glass on all models iPhone 12 through 16 Pro Max. MagSafe preserved. up-to-3 year warranty. Hyde Park.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
...
const processSteps = [
  { step: '1', title: 'Assessment', desc: 'Bring your iPhone in or WhatsApp us a photo of the damage. We quote a fixed price for parts and labour before any work begins.' },
...
const faqs = [
  {
    ...
    answer:
      'iPhone back glass repair pricing depends on your model and colour. We provide an assessment fee and written fixed-price quote before starting.',
  },
  {
