...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/iphone-repair/screen/morningside', title: 'iPhone Screen Repair Morningside | ZA Support Hyde Park', description: 'iPhone screen repair for Morningside clients. OLED and LCD screens, all models. We collect from Morningside. Same-day repair available. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
