...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/iphone-repair/screen/fourways', title: 'iPhone Screen Repair Fourways | ZA Support Hyde Park', description: 'iPhone screen repair for Fourways clients. Cracked OLED, dead touch, lines on display. iPhone 12 to 16 Pro Max. We collect from Fourways. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
