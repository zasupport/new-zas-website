...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/iphone-repair/screen/houghton', title: 'iPhone Screen Repair Houghton | ZA Support Hyde Park', description: 'iPhone screen repair for Houghton clients. OLED and LCD screens, all models. We collect from Houghton. Same-day repair available. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
  title: 'iPhone Screen Repair Houghton | ZA Support Hyde Park',
  description: 'iPhone screen repair for Houghton clients. OLED and LCD screens, all models. We collect from Houghton. Same-day repair available. Call 064 529 5863.',
  alternates: { canonical: 'https://zasupport.com/iphone-repair/screen/houghton' },
};
...
const faqs = [
  {
    question: 'Do you collect iPhones for screen repair from Houghton?',
    answer: 'We collect from Houghton, Saxonwold, Parktown, and Rosebank. WhatsApp 064 529 5863 to arrange same-day collection from Houghton.',
  },
  {
  ...
  {
    question: 'Do you repair iPads and MacBooks from Houghton as well?',
    answer: 'Yes. We repair MacBooks, iPads, Apple Watches, AirPods, and iMacs in addition to iPhones. Collection from Houghton covers all Apple device types.',
  },
];
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'iPhone Screen Repair Houghton',
  description: 'iPhone screen repair for Houghton clients. All models. Collection and return service.',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 4, name: 'Houghton', item: 'https://zasupport.com/iphone-repair/screen/houghton' },
  ],
};

const faqSchema = buildFaqSchema(faqs);

export default function IPhoneScreenRepairHoughtonPage() {
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <div className="flex items-center gap-2 text-[#7A9E98] text-sm mb-8">
              ...
              <span>Hyde Park, Johannesburg | Collection from Houghton | Same-day repair available</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href={buildWhatsAppUrl('IPH-SCR-HOUGHTON', 'iphone-repair')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 hover:shadow-[0_0_32px_rgba(15,234,122,0.4)] transition-all" >
                WhatsApp for Quote
              </a>
      ...
      <section className="py-8 sm:py-16 bg-[#0A1A18]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-[rgba(39,80,77,0.3)] border border-[rgba(15,234,122,0.2)] rounded-3xl p-10">
            <h2 className="text-3xl font-extrabold text-[#E8F4F1] mb-3">Cracked iPhone in Houghton? We Collect.</h2>
            <p className="text-[#7A9E98] mb-6">We collect from Houghton, Saxonwold, Parktown, and Rosebank.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href={buildWhatsAppUrl('IPH-SCR-HOUGHTON', 'iphone-repair')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 transition-all" >
                WhatsApp for Quote
              </a>
              <a href={`tel:${CONTACT.phoneTel}`} className="inline-flex items-center justify-center gap-2 border border-[rgba(15,234,122,0.35)] text-[#0FEA7A] px-8 py-4 rounded-xl text-lg font-semibold hover:bg-[rgba(15,234,122,0.08)] transition-all">
                <Phone className="w-5 h-5" /> Call {CONTACT.phone}
