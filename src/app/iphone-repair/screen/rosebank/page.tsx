...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/iphone-repair/screen/rosebank', title: 'iPhone Screen Repair Rosebank | ZA Support Hyde Park', description: 'iPhone screen repair for Rosebank clients. Cracked OLED, dead touch, lines on display. iPhone 12 to 16 Pro Max. We collect from Rosebank. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
