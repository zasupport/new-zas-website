...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/iphone-repair/screen/rivonia', title: 'iPhone Screen Repair Rivonia | ZA Support Hyde Park', description: 'iPhone screen repair for Rivonia clients. OLED and LCD screens, all models. We collect from Rivonia. Same-day repair available. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
  title: 'iPhone Screen Repair Rivonia | ZA Support Hyde Park',
  description: 'iPhone screen repair for Rivonia clients. OLED and LCD screens, all models. We collect from Rivonia. Same-day repair available. Call 064 529 5863.',
  alternates: { canonical: 'https://zasupport.com/iphone-repair/screen/rivonia' },
};
...
const faqs = [
  {
    question: 'Do you collect iPhones for screen repair from Rivonia?',
    answer: 'We collect from Rivonia, Sandton, Paulshof, and Sunninghill. WhatsApp 064 529 5863 to arrange same-day collection from Rivonia.',
  },
  {
    question: 'How far is Rivonia from your Hyde Park workshop?',
    answer: 'Approximately 12 km, roughly 15-20 minutes by car. Rivonia clients are well within our standard collection zone. Same-day collection is typically available.',
  },
  {
    question: 'How long does iPhone screen repair take?',
    answer: 'Most iPhone screen repairs are completed within 1-2 hours of arrival at our Hyde Park workshop. We carry stock of common iPhone screen sizes. If collection is arranged from Rivonia, same-day return is typically available.',
  },
  {
  ...
  {
    question: 'How much does iPhone screen repair cost for Rivonia clients?',
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'iPhone Screen Repair Rivonia',
  description: 'iPhone screen repair for Rivonia clients. All models. Collection and return service.',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 4, name: 'Rivonia', item: 'https://zasupport.com/iphone-repair/screen/rivonia' },
  ],
};

const faqSchema = buildFaqSchema(faqs);

export default function IPhoneScreenRepairRivoniaPage() {
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <p className="text-xl text-[#7A9E98] mb-4 max-w-3xl leading-relaxed">
              iPhone screen repair for Rivonia clients. All models from iPhone SE to iPhone 15 Pro Max. OLED and LCD screens. Collection from Rivonia, approx 15-20 minutes to Hyde Park.
            </p>
            <div className="flex items-center gap-2 text-[#7A9E98] text-sm mb-8">
              <MapPin className="w-4 h-4 text-[#0FEA7A]" />
              <span>Hyde Park, Johannesburg | Collection from Rivonia | Same-day repair available</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href={buildWhatsAppUrl('IPH-SCR-RIVONIA', 'iphone-repair')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 hover:shadow-[0_0_32px_rgba(15,234,122,0.4)] transition-all" >
                WhatsApp for Quote
              </a>
      ...
      <section className="py-10 sm:py-20 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-[#E8F4F1] mb-4">iPhone Models We Repair for Rivonia Clients</h2>
          <p className="text-[#7A9E98] mb-8 leading-relaxed">Rivonia clients are well within our standard collection zone. Same-day collection is typically available. We carry stock of common screen sizes. Less common models are ordered and typically available within 1-2 business days.</p>
      ...
      <section className="py-10 sm:py-20 bg-[#0A1A18]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <PricingNote />
          <FAQAccordion items={faqs} title={`iPhone Screen Repair Rivonia, Common Questions`} />
        </div>
      </section>
      ...
      <section className="py-8 sm:py-16 bg-[#0A1A18]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-[rgba(39,80,77,0.3)] border border-[rgba(15,234,122,0.2)] rounded-3xl p-10">
            <h2 className="text-3xl font-extrabold text-[#E8F4F1] mb-3">Cracked iPhone in Rivonia? We Collect.</h2>
            <p className="text-[#7A9E98] mb-6">We collect from Rivonia, Sandton, Paulshof, and Sunninghill.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href={buildWhatsAppUrl('IPH-SCR-RIVONIA', 'iphone-repair')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 transition-all" >
                WhatsApp for Quote
              </a>
              <a href={`tel:${CONTACT.phoneTel}`} className="inline-flex items-center justify-center gap-2 border border-[rgba(15,234,122,0.35)] text-[#0FEA7A] px-8 py-4 rounded-xl text-lg font-semibold hover:bg-[rgba(15,234,122,0.08)] transition-all">
                <Phone className="w-5 h-5" /> Call {CONTACT.phone}
