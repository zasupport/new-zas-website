...
function getIntentCTA(query: string): IntentCTA | null {
  ...
  if (isPrice || isRepair) return {
    heading: 'No-Obligation Diagnostic, Assessment',
    body: 'We assess your Mac at our assessment fee. No fix = no invoice. Logic board repairs come with a 12-month warranty.',
