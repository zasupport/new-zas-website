...
const steps = [
  ...
  },
  {
    step: '2',
    title: 'Quote',
    desc: 'The assessment fee is payable on confirmation. Fixed price confirmed before we start.',
  },
  {
    step: '3',
    title: 'Upgrade',
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'The assessment fee applies. It covers a full diagnostic and a written fixed-price quote. The fee applies if you proceed.',
  },
  {
      ...
      <section className="py-12 sm:py-20 px-4 bg-[#111C1A]">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-[#7A9E98] mb-8">
            Assessment. Fixed quote. Same-day service on most Intel MacBook Pro models. Hyde Park, Johannesburg.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href={`tel:${CONTACT.phoneTel}`}
