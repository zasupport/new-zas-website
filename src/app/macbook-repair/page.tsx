...
export const metadata: Metadata = {
  ...
  description:
    'MacBook repair in Johannesburg. Battery, screen, keyboard, liquid damage, logic board component-level repair. All M-series and Intel models. Assessment. Hyde Park. Call 064 529 5863.',
  ...
  openGraph: {
    title: 'MacBook Repair Johannesburg 2026 | ZA Support | All Models Fixed',
    description: 'MacBook repair in Johannesburg. Battery, screen, keyboard, liquid damage, logic board component-level repair. Assessment.',
...
const faqs = [
  {
    ...
    answer: 'MacBook repair costs depend on the fault type and model. We provide an assessment fee and a detailed written quote before any work begins. Contact us for a quote specific to your model and fault.',
  },
  {
  ...
  {
    question: 'Is there an Assessment policy?',
    answer: 'Yes. If we assess your MacBook and cannot repair it, or the repair is not cost-effective, assessment fee applies. We provide an honest prognosis and written quote before starting any work.',
  },
  {
...
const serviceSchema = {
  ...
  description: 'MacBook repair in Johannesburg, battery, screen, keyboard, liquid damage, logic board. All M-series and Intel models. Assessment.',
  offers: {
    '@type': 'AggregateOffer',
  },
};
    ...
    <>
      ...
      <section className="py-10 sm:py-20 bg-[#111C1A]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-[#7A9E98] text-center mb-12 max-w-2xl mx-auto">
            All costs are confirmed after an assessment fee. Final cost is confirmed in writing before work begins.
          </p>
      ...
      <section className="py-8 sm:py-16 bg-[#0A1A18]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-[rgba(39,80,77,0.3)] border border-[rgba(15,234,122,0.2)] rounded-3xl p-10">
            ...
            <p className="text-[#7A9E98] mb-6">Assessment. Honest quote. Assessment. Hyde Park, Johannesburg.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a href="/api/wa?service=macbook-repair&page=/macbook-repair" className="inline-flex items-center gap-2 border border-[rgba(15,234,122,0.35)] text-[#0FEA7A] px-8 py-4 rounded-xl font-semibold hover:bg-[rgba(15,234,122,0.08)] transition-all" target="_blank" rel="noopener noreferrer">
                WhatsApp Us
              </a>
            </div>
          </div>
