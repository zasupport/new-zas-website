...
export const metadata: Metadata = {
  ...
  description:
    'Book a Mac repair assessment in Hyde Park, Johannesburg. MacBook, iPhone, iPad, iMac, all models. Assessment. We respond within 2 hours.',
  alternates: { canonical: 'https://zasupport.com/book' },
  openGraph: {
    title: 'Book a Mac Repair, Hyde Park, Johannesburg | ZA Support',
    description: 'Book a Mac repair assessment. We respond within 2 hours.',
