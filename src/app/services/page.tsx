    ...
    },
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'We charge an assessment fee to inspect and diagnose your device. We then provide a transparent written quote. If you approve and proceed with the repair, the assessment fee applies. If you decline, the assessment fee is payable for the diagnostic work completed.',
          },
        },
        {
          '@type': 'Question',
        ...
        },
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Call or WhatsApp 064 529 5863, or email courtney@zasupport.com. An assessment fee applies, bring your device to our Hyde Park office or we can arrange a site visit for business clients.',
          },
        },
      ],
    },
          ...
          <div className="space-y-6">
            {[
              ...
              },
              {
                ...
                a: 'Call or WhatsApp 064 529 5863, or email courtney@zasupport.com. An assessment fee applies, bring your device to our Hyde Park office or we can arrange a site visit for business clients.',
              },
            ].map(({ q, a }) => (
