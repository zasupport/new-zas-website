...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://zasupport.com/battery-replacement/randburg' },
};
...
const faqs = [
  {
    question: 'Do you collect MacBooks for battery replacement from Randburg?',
    answer: 'Yes. We offer a collection and return service for Randburg clients. Your MacBook is collected from your home or office in Randburg, the battery is replaced at our Hyde Park workshop approximately 15 minutes away, and your Mac is returned once the work is complete.',
  },
  {
  ...
  },
  {
    ...
    answer: 'No. A swollen battery is a safety hazard and the Mac should not be used until the battery is replaced. If your trackpad is lifting or your MacBook case is separating, those are signs of swelling. Contact us immediately and we will arrange same-day collection from Randburg.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Apple rates MacBook batteries for 1,000 charge cycles before capacity drops below 80%. Once you are above 1,000 cycles or below 80% health, a replacement is the most cost-effective way to restore your Mac.',
  },
];
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'MacBook Battery Replacement Randburg',
  description: 'MacBook battery replacement for Randburg clients. Collection from Randburg, same-day or next-day battery replacement at Hyde Park workshop.',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Randburg', item: 'https://zasupport.com/battery-replacement/randburg' },
  ],
};

const faqSchema = buildFaqSchema(faqs);

export default function BatteryReplacementRandburgPage() {
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href={buildWhatsAppUrl('BAT-RANDBURG', 'battery')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 hover:shadow-[0_0_32px_rgba(15,234,122,0.4)] transition-all">
                WhatsApp for Quote
              </a>
      ...
      <section className="py-8 sm:py-16 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-[#E8F4F1] mb-6">
            MacBook Battery Replacement for Randburg Clients
          </h2>
      ...
      <section className="py-8 sm:py-16 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-[rgba(39,80,77,0.3)] border border-[rgba(15,234,122,0.2)] rounded-3xl p-10">
            <h2 className="text-3xl font-extrabold text-[#E8F4F1] mb-3">Randburg MacBook Battery Issue? We Collect.</h2>
            <p className="text-[#7A9E98] mb-6">Same-day or next-day battery replacement. Written warranty. Hyde Park workshop.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href={buildWhatsAppUrl('BAT-RANDBURG', 'battery')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 transition-all">
                WhatsApp for Quote
              </a>
              <a href={`tel:${CONTACT.phoneTel}`} className="inline-flex items-center justify-center gap-2 border border-[rgba(15,234,122,0.35)] text-[#0FEA7A] px-8 py-4 rounded-xl text-lg font-semibold hover:bg-[rgba(15,234,122,0.08)] transition-all">
                <Phone className="w-5 h-5" /> Call {CONTACT.phone}
