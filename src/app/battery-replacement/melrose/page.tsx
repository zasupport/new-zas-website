...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/battery-replacement/melrose', title: 'MacBook Battery Replacement Melrose | ZA Support Hyde Park', description: 'MacBook battery replacement for Melrose clients. Genuine Apple-spec batteries, fast turnaround. We collect from Melrose and replace at our Hyde Park workshop. Assessment. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
  title: 'MacBook Battery Replacement Melrose | ZA Support Hyde Park',
  description:
    'MacBook battery replacement for Melrose clients. Genuine Apple-spec batteries, fast turnaround. We collect from Melrose and replace at our Hyde Park workshop. Assessment. Call 064 529 5863.',
  alternates: { canonical: 'https://zasupport.com/battery-replacement/melrose' },
};
...
const faqs = [
  {
    question: 'Do you collect MacBooks for battery replacement from Melrose?',
    answer: 'Yes. We collect from Melrose Arch, Melrose North, and surrounding corporate precinct and carry out the replacement at our Hyde Park workshop, approximately 8 minutes away. Contact us on WhatsApp to arrange a convenient collection time.',
  },
  {
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'MacBook Battery Replacement Melrose',
  description: 'MacBook battery replacement for Melrose clients. Apple-spec batteries, fast turnaround. Collection from Melrose.',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Melrose', item: 'https://zasupport.com/battery-replacement/melrose' },
  ],
};

const faqSchema = buildFaqSchema(faqs);

export default function BatteryReplacementMelrosePage() {
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <p className="text-xl text-[#7A9E98] mb-4 max-w-3xl leading-relaxed">
              Battery replacement for Melrose residents and businesses. Apple-spec batteries, fast turnaround. We collect from Melrose and carry out the replacement at our Hyde Park workshop. Assessment.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href={buildWhatsAppUrl('BAT-MELROSE', 'battery')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 hover:shadow-[0_0_32px_rgba(15,234,122,0.4)] transition-all">
                💬 WhatsApp for Quote
              </a>
      ...
      <section className="py-8 sm:py-16 bg-[#0A1A18]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
            {[
              { label: "Rosebank", href: "/battery-replacement/rosebank" },
              { label: "Illovo", href: "/battery-replacement/illovo" },
              { label: "Sandton", href: "/battery-replacement/sandton" },
            ].map((area) => (
      ...
      <section className="py-8 sm:py-16 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-[rgba(39,80,77,0.3)] border border-[rgba(15,234,122,0.2)] rounded-3xl p-10">
            <h2 className="text-3xl font-extrabold text-[#E8F4F1] mb-3">MacBook Battery Issue in Melrose? Assessment.</h2>
            <p className="text-[#7A9E98] mb-6">We collect from Melrose. Assessment. No Fix No Fee. 12-month warranty.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href={buildWhatsAppUrl('BAT-MELROSE', 'battery')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 transition-all">
                💬 WhatsApp for Quote
              </a>
              <a href={`tel:${CONTACT.phoneTel}`} className="inline-flex items-center justify-center gap-2 border border-[rgba(15,234,122,0.35)] text-[#0FEA7A] px-8 py-4 rounded-xl text-lg font-semibold hover:bg-[rgba(15,234,122,0.08)] transition-all">
                <Phone className="w-5 h-5" /> Call {CONTACT.phone}
