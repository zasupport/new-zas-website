...
export const metadata: Metadata = {
  ...
  description:
    'MacBook battery replacement for Melrose clients. Genuine Apple-spec batteries, fast turnaround. We collect from Melrose and replace at our Hyde Park workshop. Assessment from R599. Call 064 529 5863.',
      ...
      <section className="py-8 sm:py-16 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-[rgba(39,80,77,0.3)] border border-[rgba(15,234,122,0.2)] rounded-3xl p-10">
            <h2 className="text-3xl font-extrabold text-[#E8F4F1] mb-3">MacBook Battery Issue in Melrose? Assessment from R599.</h2>
