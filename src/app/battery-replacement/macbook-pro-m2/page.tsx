...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/battery-replacement/macbook-pro-m2', title: 'MacBook Pro M2 Battery Replacement Johannesburg [2026] | ZA Support', description: 'MacBook Pro M2 battery replacement Johannesburg. 58.2Wh (13") / 70Wh (14") cells. Improved efficiency, same adhesive system. Assessment. Hyde Park.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
  title: 'MacBook Pro M2 Battery Replacement Johannesburg [2026] | ZA Support',
  description:
    'MacBook Pro M2 battery replacement Johannesburg. 58.2Wh (13") / 70Wh (14") cells. Improved efficiency, same adhesive system. Assessment. Hyde Park.',
...
const pricingRows = [
  ...
  { model: 'MacBook Pro 14″ M2 Pro (2023)', battery: '70 Wh', from: 'Contact for pricing', turnaround: '4-6 hrs' },
  { model: 'MacBook Pro 14″ M2 Max (2023)', battery: '70 Wh', from: 'Contact for pricing', turnaround: '4-6 hrs' },
  { model: 'MacBook Pro 16″ M2 Pro (2023)', battery: '100 Wh', from: 'Contact for pricing', turnaround: '4-6 hrs' },
  { model: 'MacBook Pro 16″ M2 Max (2023)', battery: '100 Wh', from: 'Contact for pricing', turnaround: '4-6 hrs' },
];
...
const faqs = [
  {
    ...
    answer:
      'MacBook Pro M2 13-inch battery replacement is carried out at our Hyde Park workshop. The M2 Pro and M2 Max 14-inch and 16-inch models cost more due to their larger cells (70 Wh and 100 Wh respectively) and the additional adhesive sections. The Apple Store charges many times more for the same service. Our price includes the replacement cell, all labour, calibration, and a written warranty of up to 3 years. The assessment fee is applied toward the repair cost if you proceed.',
  },
  {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <p className="text-xl text-[#7A9E98] mb-4 max-w-3xl leading-relaxed">
              Second-generation Apple Silicon, 58.2 Wh (13&quot;), 70 Wh (14&quot;), or 100 Wh (16&quot;) cell replacement at our Hyde Park workshop. M2 efficiency + load shedding micro-cycles = faster battery wear than most owners expect. Same-day service available.
            </p>
      ...
      <section className="py-10 sm:py-20 bg-[#111C1A]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-[#7A9E98] mb-8 max-w-3xl leading-relaxed">
            Pricing includes the replacement cell, labour, calibration, and our written warranty. Apple charges many times more for the equivalent service, and sometimes replaces the entire top case assembly rather than the battery alone. We replace the battery cells only.
          </p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-[rgba(39,80,77,0.3)] border border-[rgba(15,234,122,0.2)] rounded-3xl p-10">
            ...
            <p className="text-[#7A9E98] mb-6 max-w-xl mx-auto leading-relaxed">
              WhatsApp us a description of the fault, reduced runtime, unexpected shutdowns, swollen battery, or "Service Recommended", and we will give you an honest price range before you bring the machine in.  Assessment, applied toward the repair if you proceed.
            </p>
