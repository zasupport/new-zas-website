...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/battery-replacement/bryanston', title: 'MacBook Battery Replacement Bryanston | ZA Support Hyde Park', description: 'MacBook battery replacement for Bryanston clients. Genuine Apple-spec batteries, same-day service. We collect from Bryanston and replace at our Hyde Park workshop. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
    ...
    <>
      ...
      <section className="py-8 sm:py-16 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4 text-[#7A9E98] leading-relaxed">
            ...
            <p>
              If you are unsure whether your battery needs replacing, we check the cycle count and health percentage before proceeding. An assessment fee applies for the health check.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-10 sm:py-20 bg-[#0A1A18]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <PricingRange page="/battery-replacement/bryanston" />
