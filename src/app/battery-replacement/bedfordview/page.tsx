...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/battery-replacement/bedfordview', title: 'MacBook Battery Replacement Bedfordview | ZA Support Hyde Park', description: 'MacBook battery replacement for Bedfordview clients. Genuine Apple-spec batteries, fast turnaround. We collect from Bedfordview and replace at our Hyde Park workshop. Assessment. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
...
const faqs = [
  {
    question: 'Do you collect MacBooks for battery replacement from Bedfordview?',
    answer: 'Yes. We collect from Bedfordview, Greenstone, and the east Rand residential belt and carry out the replacement at our Hyde Park workshop, approximately 25 minutes away. Contact us on WhatsApp to arrange a convenient collection time.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Yes, a raised or stiff trackpad almost always indicates a swollen battery. Do not continue using the machine. A swollen lithium battery is a fire risk. Contact us immediately for an urgent collection from Bedfordview.',
  },
  {
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'MacBook Battery Replacement Bedfordview',
  description: 'MacBook battery replacement for Bedfordview clients. Apple-spec batteries, fast turnaround. Collection from Bedfordview.',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Bedfordview', item: 'https://zasupport.com/battery-replacement/bedfordview' },
  ],
};

const faqSchema = buildFaqSchema(faqs);

export default function BatteryReplacementBedfordviewPage() {
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[#E8F4F1] leading-tight mb-6">
              MacBook Battery Replacement Bedfordview
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href={buildWhatsAppUrl('BAT-BEDFORDV', 'battery')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 hover:shadow-[0_0_32px_rgba(15,234,122,0.4)] transition-all">
                💬 WhatsApp for Quote
              </a>
      ...
      <section className="py-10 sm:py-20 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <PricingNote />
          <FAQAccordion items={faqs} title="Battery Replacement Bedfordview, Common Questions" />
        </div>
      </section>
