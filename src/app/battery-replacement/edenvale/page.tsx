...
export const metadata: Metadata = {
  ...
  description:
    'MacBook battery replacement for Edenvale clients. Genuine Apple-spec batteries, fast turnaround. We collect from Edenvale and replace at our Hyde Park workshop. Assessment from R599. Call 064 529 5863.',
  alternates: { canonical: 'https://zasupport.com/battery-replacement/edenvale' },
};
...
const faqs = [
  {
    question: 'Do you collect MacBooks for battery replacement from Edenvale?',
    answer: 'Yes. We collect from Edenvale, Bedfordview, and the OR Tambo east corridor and carry out the replacement at our Hyde Park workshop, approximately 25 minutes away. Contact us on WhatsApp to arrange a convenient collection time.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Yes — a raised or stiff trackpad almost always indicates a swollen battery. Do not continue using the machine. A swollen lithium battery is a fire risk. Contact us immediately for an urgent collection from Edenvale.',
  },
  {
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'MacBook Battery Replacement Edenvale',
  description: 'MacBook battery replacement for Edenvale clients. Apple-spec batteries, fast turnaround. Collection from Edenvale.',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Edenvale', item: 'https://zasupport.com/battery-replacement/edenvale' },
  ],
};

const faqSchema = buildFaqSchema(faqs);

export default function BatteryReplacementEdenvalePage() {
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[#E8F4F1] leading-tight mb-6">
              MacBook Battery Replacement Edenvale
              <br /><span className="text-[#0FEA7A]">— Restore Full Runtime</span>
            </h1>
            <p className="text-xl text-[#7A9E98] mb-4 max-w-3xl leading-relaxed">
              Battery replacement for Edenvale residents and businesses. Apple-spec batteries, fast turnaround. We collect from Edenvale and carry out the replacement at our Hyde Park workshop. Assessment from R599.
            </p>
            <div className="flex items-center gap-2 text-[#7A9E98] text-sm mb-8">
              <MapPin className="w-4 h-4 text-[#0FEA7A]" />
              <span>Collection from Edenvale — approx. 25 min to our Hyde Park workshop</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href={buildWhatsAppUrl('BAT-EDENVALE', 'battery')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 hover:shadow-[0_0_32px_rgba(15,234,122,0.4)] transition-all">
                💬 WhatsApp for Quote
              </a>
      ...
      <section className="py-10 sm:py-20 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <FAQAccordion items={faqs} title="Battery Replacement Edenvale — Common Questions" />
        </div>
      </section>
      ...
      <section className="py-8 sm:py-16 bg-[#0A1A18]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
            {[
              { label: "Bedfordview", href: "/battery-replacement/bedfordview" },
      ...
      <section className="py-8 sm:py-16 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-[rgba(39,80,77,0.3)] border border-[rgba(15,234,122,0.2)] rounded-3xl p-10">
            <h2 className="text-3xl font-extrabold text-[#E8F4F1] mb-3">MacBook Battery Issue in Edenvale? Assessment from R599.</h2>
            <p className="text-[#7A9E98] mb-6">We collect from Edenvale. Assessment from R599. No Fix No Fee. 12-month warranty.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href={buildWhatsAppUrl('BAT-EDENVALE', 'battery')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 transition-all">
                💬 WhatsApp for Quote
              </a>
              <a href={`tel:${CONTACT.phoneTel}`} className="inline-flex items-center justify-center gap-2 border border-[rgba(15,234,122,0.35)] text-[#0FEA7A] px-8 py-4 rounded-xl text-lg font-semibold hover:bg-[rgba(15,234,122,0.08)] transition-all">
                <Phone className="w-5 h-5" /> Call {CONTACT.phone}
