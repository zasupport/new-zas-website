...
export const metadata: Metadata = {
  ...
  description: 'MacBook battery replacement for Parktown North clients. Same-day service, from R1,899. Collection from Parktown North. Written warranty. Call 064 529 5863.',
...
const serviceSchema = {
  ...
  description: 'Same-day MacBook battery replacement for Parktown North clients. From R1,899. Collection included.',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <div className="flex items-center gap-2 text-[#7A9E98] text-sm mb-8">
              ...
              <span>Hyde Park, Johannesburg | From R1,899 | Same-day service | Collecting from Parktown North</span>
            </div>
