...
export const metadata: Metadata = {
  ...
  description:
    'MacBook battery replacement for Germiston clients. Genuine Apple-spec batteries, fast turnaround. We collect from Germiston and replace at our Hyde Park workshop. Assessment from R599. Call 064 529 5863.',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <p className="text-xl text-[#7A9E98] mb-4 max-w-3xl leading-relaxed">
              Battery replacement for Germiston residents and businesses. Apple-spec batteries, fast turnaround. We collect from Germiston and carry out the replacement at our Hyde Park workshop. Assessment from R599.
            </p>
      ...
      <section className="py-8 sm:py-16 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-[rgba(39,80,77,0.3)] border border-[rgba(15,234,122,0.2)] rounded-3xl p-10">
            <h2 className="text-3xl font-extrabold text-[#E8F4F1] mb-3">MacBook Battery Issue in Germiston? Assessment from R599.</h2>
