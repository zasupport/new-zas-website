...
const services = [
	{
		...
		description:
			"MacBook Air and Pro repair, screen, battery, keyboard, board-level faults. All M1/M2/M3/M4 and Intel models.",
		href: "/macbook-repair",
		accent: "text-[#0FEA7A]",
	...
	},
	{
		...
		description:
			"Expert component-level repair for no-power, no-display, USB-C failure, and GPU faults.",
	...
	},
	{
		...
		description:
			"MacBook, iPhone, iPad, Apple Watch. Board-level ultrasonic cleaning and component repair.",
		href: "/liquid-damage",
	...
	},
	{
		...
		title: "iPhone Repair",
		description:
			"Screen, battery, charging port, liquid damage, back glass. All models including iPhone 16.",
		href: "/iphone-repair",
		accent: "text-[#0FEA7A]",
	...
	},
	{
		...
		title: "iPad Repair",
		description:
			"Screen replacement, battery, charging, and liquid damage. All iPad generations.",
		href: "/ipad-repair",
	...
	},
	{
		...
		title: "JAMF MDM",
		description:
			"Enterprise Apple device management. JAMF Pro and JAMF Now implementation.",
		href: "/jamf-mdm",
	...
	},
	{
		...
		description:
			"Apple-first MSP for businesses. Full IT ownership, monitoring, and support.",
...
const differentiators = [
	{
		...
		description:
			"We repair the chips others replace. Our engineers perform component-level repairs under microscope, saving you thousands compared to board replacement.",
	},
	{
		icon: Award,
		title: "Apple MDM Specialists",
		description:
			"We implement and manage Apple device fleets for medical practices, SMEs, and enterprise clients across Johannesburg and Gauteng.",
	},
	{
		icon: Star,
	...
	},
	{
		...
		description:
			"Since 2009, ZA Support has been Johannesburg's go-to Apple specialists. We've seen and fixed every failure mode in every Apple device.",
	},
];
...
const homepageFaqs = [
	...
	},
	{
		...
		answer:
			"ZA Support charges an assessment fee. This covers a full diagnostic inspection of your device. The assessment fee is separate from the repair quotation and is non-refundable. It is not credited toward, deducted from, or included in the repair cost, and it applies whether or not you proceed with the repair. After the assessment we provide a written repair quotation, and no repair work begins until you approve it. All repairs carry an up-to-3-year warranty on parts and labour.",
	},
	{
	...
	return (
		<>
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="max-w-4xl">
						...
						<h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[#E8F4F1] leading-[1.05] mb-6">
							Johannesburg&apos;s
							<br />
							<span className="text-[#0FEA7A] glow-text-green">
								Apple Specialists
							</span>
						</h1>

						<p className="speakable-summary text-base sm:text-lg text-[#7A9E98] mb-8 max-w-2xl leading-relaxed">
							MacBook liquid damage, logic board component-level repair, screen,
							battery, iPhone. Hyde Park, Johannesburg. Assessment. up-to-3 year
							warranty.
						</p>
						...
						<p className="mt-4 text-[#7A9E98] text-sm">
							Mon-Thu: 08:00-17:00 · Fri: 08:00-16:30 · Closed Sat & Sun · Hyde
							Park, Johannesburg
						</p>
					</div>
				</div>
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="flex items-center gap-6 sm:gap-10 overflow-x-auto pb-1 sm:flex-wrap sm:justify-center">
						{[
							...
							<div
								key={label}
								className="flex items-center gap-2 text-[#E8F4F1]"
							>
			...
			<section className="py-8 bg-[#0A1A18] border-b border-[rgba(15,234,122,0.06)]">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<p className="text-center text-[#7A9E98] text-xs uppercase tracking-widest mb-6">
						Recognised by
					</p>
					<div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
						{[
							...
							<div
								key={award.name}
								className="flex flex-col items-center text-center p-4 rounded-xl bg-[rgba(22,34,32,0.4)] border border-[rgba(15,234,122,0.08)]"
							>
								<Award className="w-6 h-6 text-[#0FEA7A] mb-2" />
								<span className="text-[#E8F4F1] text-sm font-semibold">
									{award.name}
								</span>
			...
			<section className="py-12 sm:py-20 bg-[#0A1A18]">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center mb-12">
						...
						<p className="text-[#7A9E98] text-lg">
							Over {SITE.reviewCount} verified reviews from Johannesburg clients
							· 16 years of Apple expertise
						</p>
					</div>
					<Suspense
						fallback={
							<div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
								{[1, 2, 3, 4].map((i) => (
									<div
										key={i}
										className="p-6 rounded-2xl bg-[rgba(22,34,32,0.6)] border border-[rgba(15,234,122,0.12)] animate-pulse"
									>
										<div className="flex gap-1 mb-3">
											{[1, 2, 3, 4, 5].map((s) => (
												<div
													key={s}
													className="w-4 h-4 bg-[rgba(15,234,122,0.15)] rounded"
												/>
											))}
										</div>
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
						{differentiators.map((item) => {
							...
							return (
								<div
									key={item.title}
									className="flex gap-5 p-6 rounded-2xl bg-[rgba(22,34,32,0.5)] border border-[rgba(15,234,122,0.1)] hover:border-[rgba(15,234,122,0.25)] transition-all"
								>
									...
									<div>
										<h3 className="text-[#E8F4F1] font-bold text-lg mb-2">
											{item.title}
										</h3>
				...
				<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
					<div className="bg-[rgba(39,80,77,0.3)] border border-[rgba(15,234,122,0.2)] rounded-3xl p-12">
						...
						<p className="text-[#7A9E98] text-lg mb-8 max-w-2xl mx-auto">
							Bring your device in. We&apos;ll assess it, give you a clear
							quote, and fix it fast, backed by a up-to-3 year warranty.
						...
						<p className="mt-6 text-[#7A9E98] text-sm">
							1 Hyde Lane, Hyde Park, Johannesburg · Mon-Thu 08:00-17:00 · Fri
