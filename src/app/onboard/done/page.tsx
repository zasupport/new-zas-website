...
function DoneContent() {
  ...
  return (
    <div style={{ textAlign: 'center', padding: '20px 0' }}>
      ...
      <h2 style={{ fontSize: 22, fontWeight: 700, color: C.text, fontFamily: f, marginBottom: 6 }}>Welcome Aboard</h2>
      <p style={{ fontSize: 13, color: C.muted, fontFamily: f, maxWidth: 400, margin: '0 auto 24px' }}>Your practice is now protected.</p>
      <div style={{ display: 'grid', gap: 10, textAlign: 'left', maxWidth: 440, margin: '0 auto 24px' }}>
        {([
          ['📄', 'Contract pending', 'Your service agreement is being prepared and will be emailed to you shortly'],
          ['📅', 'Assessment within 24 hrs', 'We will contact you to schedule your Digital Risk Assessment'],
          ['🛡️', 'Monitoring active', 'Basic threat monitoring begins immediately'],
          ['💳', 'Next billing: 25th', 'Recurring charge on the 25th of each month'],
          ['📊', 'First report in 30 days', 'Monthly security report after assessment'],
