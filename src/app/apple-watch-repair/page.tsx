...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/apple-watch-repair', title: 'Apple Watch Repair Johannesburg | Screen & Battery | ZA Support', description: 'Apple Watch repair in Johannesburg. Screen replacement, battery replacement, crown and button repair. Assessment. up-to-3 year warranty. Hyde Park.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
