...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/logic-board-repair/paulshof', title: 'MacBook Logic Board Repair Paulshof | ZA Support Hyde Park', description: 'MacBook logic board repair for Paulshof clients. Component-level repair, assessment. We collect from Paulshof. No Fix No Fee. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
  title: 'MacBook Logic Board Repair Paulshof | ZA Support Hyde Park',
  description: 'MacBook logic board repair for Paulshof clients. Component-level repair, assessment. We collect from Paulshof. No Fix No Fee. Call 064 529 5863.',
  alternates: { canonical: 'https://zasupport.com/logic-board-repair/paulshof' },
};
...
const faqs = [
  {
    question: 'Do you collect MacBooks for logic board repair from Paulshof?',
    answer: 'We collect from Paulshof, Sunninghill, Rivonia, and Fourways. We collect, repair at our Hyde Park workshop, and return once complete. WhatsApp 064 529 5863 to arrange.',
  },
  {
    question: 'How far is Paulshof from your Hyde Park workshop?',
    answer: 'Approximately 17 km from Paulshof to our workshop at 1 Hyde Lane, Second Floor, Office E2004, roughly 20-25 minutes by car. Paulshof clients are collected on the same runs as Sunninghill and Rivonia.',
  },
  {
    question: 'What does MacBook logic board repair cost for Paulshof clients?',
    answer: 'Assessment. Repair cost depends on the specific fault, quoted in writing before any work proceeds. No Fix No Fee applies to all Paulshof clients.',
  },
  {
  ...
  {
    question: 'Do you offer No Fix No Fee for Paulshof clients?',
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'MacBook Logic Board Repair Paulshof',
  description: 'Component-level MacBook logic board repair for Paulshof clients. Assessment.',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Paulshof', item: 'https://zasupport.com/logic-board-repair/paulshof' },
  ],
};

const faqSchema = buildFaqSchema(faqs);

export default function LogicBoardRepairPaulshofPage() {
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[#E8F4F1] leading-tight mb-6">
              ...
              <br /><span className="text-[#0FEA7A]">Paulshof</span>
            </h1>
            <p className="text-xl text-[#7A9E98] mb-4 max-w-3xl leading-relaxed">
              Component-level MacBook logic board repair for Paulshof clients. No power, charging faults, liquid damage, display failures, and USB-C faults repaired at our Hyde Park workshop. Collection from Paulshof.
            </p>
            <div className="flex items-center gap-2 text-[#7A9E98] text-sm mb-8">
              <MapPin className="w-4 h-4 text-[#0FEA7A]" />
              <span>Hyde Park, Johannesburg | Assessment | Collecting from Paulshof, approx 20-25 min drive</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href={buildWhatsAppUrl('LBR-PAULSHOF', 'logic-board')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 hover:shadow-[0_0_32px_rgba(15,234,122,0.4)] transition-all" >
                WhatsApp for Quote
              </a>
      ...
      <section className="py-10 sm:py-20 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-[#E8F4F1] mb-4">MacBook Logic Board Faults We Repair for Paulshof Clients</h2>
          <p className="text-[#7A9E98] mb-8 leading-relaxed">Paulshof clients are collected on the same runs as Sunninghill and Rivonia. All MacBook models from 2015 onwards are covered, Intel and Apple Silicon. Faults assessed at component level. Written quote before any repair proceeds.</p>
      ...
      <section className="py-10 sm:py-20 bg-[#0A1A18]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <PricingNote />
          <FAQAccordion items={faqs} title={`MacBook Logic Board Repair Paulshof, Common Questions`} />
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            {[
              ...
              { label: 'Liquid Damage Paulshof', href: '/liquid-damage/paulshof' },
              { label: 'Battery Replacement Paulshof', href: '/battery-replacement/paulshof' },
              { label: 'iPhone Repair Paulshof', href: '/iphone-repair/screen/paulshof' },
      ...
      <section className="py-8 sm:py-16 bg-[#0A1A18]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-[rgba(39,80,77,0.3)] border border-[rgba(15,234,122,0.2)] rounded-3xl p-10">
            ...
            <p className="text-[#7A9E98] mb-6">Collecting from Paulshof. No Fix No Fee.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href={buildWhatsAppUrl('LBR-PAULSHOF', 'logic-board')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 transition-all" >
                WhatsApp for Quote
              </a>
              <a href={`tel:${CONTACT.phoneTel}`} className="inline-flex items-center justify-center gap-2 border border-[rgba(15,234,122,0.35)] text-[#0FEA7A] px-8 py-4 rounded-xl text-lg font-semibold hover:bg-[rgba(15,234,122,0.08)] transition-all">
                <Phone className="w-5 h-5" /> Call {CONTACT.phone}
