...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/logic-board-repair/northcliff', title: 'MacBook Logic Board Repair Northcliff | ZA Support Hyde Park', description: 'MacBook logic board repair for Northcliff clients. Component-level repair, assessment. We collect from Northcliff. No Fix No Fee. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
  title: 'MacBook Logic Board Repair Northcliff | ZA Support Hyde Park',
  description: 'MacBook logic board repair for Northcliff clients. Component-level repair, assessment. We collect from Northcliff. No Fix No Fee. Call 064 529 5863.',
  alternates: { canonical: 'https://zasupport.com/logic-board-repair/northcliff' },
};
...
const faqs = [
  {
    question: 'Do you collect MacBooks for logic board repair from Northcliff?',
    answer: 'We collect from Northcliff, Randburg, Robindale, and Blairgowrie. We collect, repair at our Hyde Park workshop, and return once complete. WhatsApp 064 529 5863 to arrange.',
  },
  {
    question: 'How far is Northcliff from your Hyde Park workshop?',
    answer: 'Approximately 16 km from Northcliff to our workshop at 1 Hyde Lane, Second Floor, Office E2004, roughly 20-25 minutes by car. Northcliff is directly served from our Hyde Park collection route via Randburg.',
  },
  {
    question: 'What does MacBook logic board repair cost for Northcliff clients?',
    answer: 'Assessment. Repair cost depends on the specific fault, quoted in writing before any work proceeds. No Fix No Fee applies to all Northcliff clients.',
  },
  {
  ...
  {
    question: 'Do you offer No Fix No Fee for Northcliff clients?',
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'MacBook Logic Board Repair Northcliff',
  description: 'Component-level MacBook logic board repair for Northcliff clients. Assessment.',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Northcliff', item: 'https://zasupport.com/logic-board-repair/northcliff' },
  ],
};

const faqSchema = buildFaqSchema(faqs);

export default function LogicBoardRepairNorthcliffPage() {
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[#E8F4F1] leading-tight mb-6">
              ...
              <br /><span className="text-[#0FEA7A]">Northcliff</span>
            </h1>
            <p className="text-xl text-[#7A9E98] mb-4 max-w-3xl leading-relaxed">
              Component-level MacBook logic board repair for Northcliff clients. No power, charging faults, liquid damage, display failures, and USB-C faults repaired at our Hyde Park workshop. Collection from Northcliff.
            </p>
            <div className="flex items-center gap-2 text-[#7A9E98] text-sm mb-8">
              <MapPin className="w-4 h-4 text-[#0FEA7A]" />
              <span>Hyde Park, Johannesburg | Assessment | Collecting from Northcliff, approx 20-25 min drive</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href={buildWhatsAppUrl('LBR-NORTHCLIFF', 'logic-board')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 hover:shadow-[0_0_32px_rgba(15,234,122,0.4)] transition-all" >
                WhatsApp for Quote
              </a>
      ...
      <section className="py-10 sm:py-20 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-[#E8F4F1] mb-4">MacBook Logic Board Faults We Repair for Northcliff Clients</h2>
          <p className="text-[#7A9E98] mb-8 leading-relaxed">Northcliff is directly served from our Hyde Park collection route via Randburg. All MacBook models from 2015 onwards are covered, Intel and Apple Silicon. Faults assessed at component level. Written quote before any repair proceeds.</p>
      ...
      <section className="py-10 sm:py-20 bg-[#0A1A18]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <PricingNote />
          <FAQAccordion items={faqs} title={`MacBook Logic Board Repair Northcliff, Common Questions`} />
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            {[
              ...
              { label: 'Liquid Damage Northcliff', href: '/liquid-damage/northcliff' },
              { label: 'Battery Replacement Northcliff', href: '/battery-replacement/northcliff' },
              { label: 'iPhone Repair Northcliff', href: '/iphone-repair/screen/northcliff' },
      ...
      <section className="py-8 sm:py-16 bg-[#0A1A18]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-[rgba(39,80,77,0.3)] border border-[rgba(15,234,122,0.2)] rounded-3xl p-10">
            ...
            <p className="text-[#7A9E98] mb-6">Collecting from Northcliff. No Fix No Fee.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href={buildWhatsAppUrl('LBR-NORTHCLIFF', 'logic-board')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 transition-all" >
                WhatsApp for Quote
              </a>
              <a href={`tel:${CONTACT.phoneTel}`} className="inline-flex items-center justify-center gap-2 border border-[rgba(15,234,122,0.35)] text-[#0FEA7A] px-8 py-4 rounded-xl text-lg font-semibold hover:bg-[rgba(15,234,122,0.08)] transition-all">
                <Phone className="w-5 h-5" /> Call {CONTACT.phone}
