...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/logic-board-repair/mac-mini', title: 'Mac Mini Logic Board Repair Johannesburg', description: 'Mac mini logic board repair Johannesburg. M1, M2, M2 Pro, M4, and Intel models. We fix the chip, not the board. Assessment, up-to-3 year warranty. Hyde Park. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <p className="text-xl text-[#7A9E98] mb-6 max-w-3xl leading-relaxed">
              ...
              We replace the failed component. Apple replaces the board. Assessment.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              >
                Diagnostic <ArrowRight className="w-5 h-5" />
              </Link>
            </div>
          </div>
        </div>
            ...
            <div>
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex items-center gap-3 p-3 bg-[rgba(15,234,122,0.05)] rounded-lg border border-[rgba(15,234,122,0.1)]">
                  ...
                  <p className="text-[#7A9E98] text-sm"><span className="text-[#E8F4F1] font-semibold">Assessment</span>, If we cannot repair it, assessment fee applies.</p>
                </div>
                <div className="flex items-center gap-3 p-3 bg-[rgba(15,234,122,0.05)] rounded-lg border border-[rgba(15,234,122,0.1)]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              {
                title: 'Assessment',
                desc: 'If we cannot repair your Mac mini, assessment fee applies, including the diagnostic. We back our diagnosis with our own fee. That is how confident we are.',
              },
              {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
            {[
              ...
              { title: 'iMac Logic Board', href: '/logic-board-repair/imac', label: 'Assessment' },
