...
const faqs = [
  { question: 'How much does MacBook Air M4 logic board repair cost in Johannesburg?', answer: 'Apple replaces the whole board and quotes roughly R15,000–R30,000 for an M4 Air. ZA Support repairs only the failed component on your existing board — component-level MacBook Air repairs start from R2,500 depending on the fault. After the R599 assessment we give a written, fixed-price quote before any work begins.' },
