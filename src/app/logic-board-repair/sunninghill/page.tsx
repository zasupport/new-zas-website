...
export const metadata: Metadata = {
  ...
  description: 'MacBook logic board repair for Sunninghill clients. Component-level repair, assessment from R599. We collect from Sunninghill. No Fix No Fee. Call 064 529 5863.',
...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Assessment from R599. Repair cost depends on the specific fault — quoted in writing before any work proceeds. No Fix No Fee applies to all Sunninghill clients.',
  },
  {
...
const serviceSchema = {
  ...
  description: 'Component-level MacBook logic board repair for Sunninghill clients. Assessment from R599.',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <div className="flex items-center gap-2 text-[#7A9E98] text-sm mb-8">
              ...
              <span>Hyde Park, Johannesburg | Assessment from R599 | Collecting from Sunninghill — approx 20–25 min drive</span>
            </div>
