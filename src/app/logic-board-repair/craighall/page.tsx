...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/logic-board-repair/craighall', title: 'MacBook Logic Board Repair Craighall | ZA Support Hyde Park', description: 'MacBook logic board repair for Craighall clients. Component-level repair, assessment. We collect from Craighall. No Fix No Fee. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
...
const faults = [
  { title: 'No Power', desc: 'MacBook shows no signs of life. We trace the power rail from the charging port through to the SoC power domain. The most common cause we see from Craighall clients is USB-C controller or power management IC damage from load shedding surges, South Africa\'s grid instability accounts for roughly 35% of the no-power boards that arrive at our Hyde Park workshop.' },
...
const faqs = [
  {
    question: 'Do you collect MacBooks for logic board repair from Craighall?',
    answer: 'Yes. We collect from Craighall and the surrounding Johannesburg North area. Craighall is approximately 3 km from our Hyde Park workshop, roughly 5-8 minutes by car. We collect, repair at our workshop at 1 Hyde Park Lane, and return once complete. WhatsApp 064 529 5863 to arrange same-day collection.',
  },
  {
    question: 'How far is Craighall from your Hyde Park workshop?',
    answer: 'Approximately 3 km, roughly 5-8 minutes by car depending on traffic. Craighall is one of our regular collection areas in Johannesburg North.',
  },
  {
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Craighall', item: 'https://zasupport.com/logic-board-repair/craighall' },
  ],
};

const faqSchema = buildFaqSchema(faqs);

export default function LogicBoardRepairCraighallPage() {
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <p className="text-xl text-[#7A9E98] mb-4 max-w-3xl leading-relaxed">
              Component-level MacBook logic board repair for Craighall clients. No power, charging faults, liquid damage, display failures, and USB-C faults repaired at our Hyde Park workshop. Collection from Craighall, approximately 3 km, 5-8 minutes by car.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href={buildWhatsAppUrl('LBR-CRAIGHALL', 'logic-board')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 hover:shadow-[0_0_32px_rgba(15,234,122,0.4)] transition-all">
                WhatsApp for Quote
              </a>
      ...
      <section className="py-10 sm:py-20 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-[#E8F4F1] mb-4">MacBook Logic Board Faults We Repair for Craighall Clients</h2>
          <p className="text-[#7A9E98] mb-8 leading-relaxed">Craighall is approximately 3 km from our Hyde Park workshop, one of our regular collection areas in Johannesburg North. All MacBook models from 2015 onwards are covered, Intel and Apple Silicon. Every fault is assessed at component level with a written quote before any repair proceeds.</p>
      ...
      <section className="py-10 sm:py-20 bg-[#0A1A18]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <PricingNote />
          <FAQAccordion items={faqs} title={`MacBook Logic Board Repair Craighall, Common Questions`} />
        </div>
      </section>
