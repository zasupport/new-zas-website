...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/logic-board-repair/houghton', title: 'MacBook Logic Board Repair Houghton | ZA Support Hyde Park', description: 'MacBook logic board repair for Houghton clients. Component-level repair, assessment. We collect from Houghton. No Fix No Fee. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
  title: 'MacBook Logic Board Repair Houghton | ZA Support Hyde Park',
  description: 'MacBook logic board repair for Houghton clients. Component-level repair, assessment. We collect from Houghton. No Fix No Fee. Call 064 529 5863.',
...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Assessment. Repair cost depends on the specific fault, quoted in writing before any work proceeds. No Fix No Fee applies to all Houghton clients.',
  },
  {
...
const serviceSchema = {
  ...
  description: 'Component-level MacBook logic board repair for Houghton clients. Assessment.',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <div className="flex items-center gap-2 text-[#7A9E98] text-sm mb-8">
              ...
              <span>Hyde Park, Johannesburg | Assessment | Collecting from Houghton, approx 10-15 min drive</span>
            </div>
