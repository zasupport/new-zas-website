...
const faqs = [
  { question: 'My M5 MacBook Pro is new — why not just use the Apple warranty?', answer: 'Apple’s warranty covers manufacturing defects, not accidental damage. Surge, liquid and drop damage — the faults we see on new M5 MacBook Pros — are excluded, so Apple quotes a full out-of-pocket board replacement (roughly R25,000–R60,000). We repair the specific failed component on your existing board for significantly less. Assessment from R599.' },
  ...
  { question: 'How much does M5 MacBook Pro logic board repair cost?', answer: 'Apple replaces the whole board and quotes roughly R25,000–R60,000 for an M5 MacBook Pro. We repair only the failed component on your existing board, which is significantly less. After the R599 assessment we provide a written, fixed-price quote before any work begins.' },
