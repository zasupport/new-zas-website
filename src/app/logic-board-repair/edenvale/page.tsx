...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/logic-board-repair/edenvale', title: 'MacBook Logic Board Repair Edenvale | ZA Support Hyde Park', description: 'MacBook logic board repair for Edenvale residents. Component-level repair, board diagnostics, assessment. We collect from Edenvale and repair at our Hyde Park workshop. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
  title: 'MacBook Logic Board Repair Edenvale | ZA Support Hyde Park',
  description:
    'MacBook logic board repair for Edenvale residents. Component-level repair, board diagnostics, assessment. We collect from Edenvale and repair at our Hyde Park workshop. Call 064 529 5863.',
...
const faqs = [
  { question: 'Do you collect MacBooks from Edenvale?', answer: 'Yes. We collect from across Edenvale, Hurlyvale, Eastleigh, Dowerglen, Sebenza, and the Greenstone Hill side, and bring the machine back to our Hyde Park workshop. Pickups are usually arranged for the next working day once you message us with your address and a short description of the fault.' },
  { question: 'How far is Edenvale from your Hyde Park workshop?', answer: 'Roughly 25 minutes outside of peak traffic via the M1, give or take depending on whether you are closer to Bedfordview or further out toward Greenstone. We factor that into our collection runs so your MacBook is not sitting in a vehicle for half the day.' },
  ...
  { question: 'What is the assessment fee?', answer: 'Our assessment fee applies. That covers the full diagnostic, microscope inspection, power-rail testing, and a written quote with the failed component identified. If you go ahead with the repair, that fee is included in the repair quote rather than charged on top.' },
  { question: 'Do you offer an Assessment guarantee?', answer: 'Yes. The assessment applies and you receive a clear written diagnosis with the actual fault identified before any repair work begins. You decide whether to proceed once you have the quote, there is no pressure and no work done without your sign-off.' },
...
const serviceSchema = {
  ...
  description: 'Expert MacBook logic board repair and component-level repair for Edenvale clients. Collection from Edenvale, repair at Hyde Park workshop. Assessment.',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <p className="text-xl text-[#7A9E98] mb-4 max-w-3xl leading-relaxed">
              Edenvale MacBook logic board repair, handled at component level by our Hyde Park workshop roughly 25 minutes west. We collect from homes off Van Riebeeck Avenue, businesses around Greenstone Hill, and residents near the Edenvale Lake precinct. Assessment, and the same technician who diagnoses your board does the rework.
            </p>
      ...
      <section className="py-8 sm:py-16 bg-[#0A1A18]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-[rgba(39,80,77,0.3)] border border-[rgba(15,234,122,0.2)] rounded-3xl p-10">
            <h2 className="text-3xl font-extrabold text-[#E8F4F1] mb-3">Edenvale MacBook Fault? Assessment.</h2>
            <p className="text-[#7A9E98] mb-6">We collect from Edenvale. Assessment. 12-month warranty. Hyde Park workshop.</p>
