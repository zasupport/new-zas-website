...
export const metadata: Metadata = {
  ...
  description: 'MacBook logic board repair for Pretoria clients. Component-level repair, assessment from R599. We collect from Pretoria. No Fix No Fee. Call 064 529 5863.',
...
const serviceSchema = {
  ...
  description: 'Component-level MacBook logic board repair for Pretoria clients. Assessment from R599.',
