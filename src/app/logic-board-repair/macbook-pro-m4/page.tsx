...
export const metadata: Metadata = {
  ...
  description: 'MacBook Pro M4, M4 Pro, M4 Max (14-inch & 16-inch, 2024) logic board repair in Johannesburg. Thunderbolt 5, MagSafe 3, no power, charging, XDR display, liquid damage, component-level. Assessment.',
...
const faults = [
  ...
  { fault: 'Liquid Damage', desc: 'On the M4 MacBook Pro the keyboard remains the main liquid entry point, and spills reach the left-side I/O cluster, Thunderbolt controller and power-management ICs, first. Ultrasonic cleaning within the first 24 hours markedly improves recovery; we assess corrosion spread as part of the diagnostic.' },
...
const faqs = [
  { question: 'How much does MacBook Pro M4 logic board repair cost in Johannesburg?', answer: 'Apple replaces the entire board, which is far more expensive than repairing the failed component. ZA Support repairs only the part that failed on your existing board, so the cost is significantly lower. After the assessment we give a written, fixed-price quote before any work begins. The exact price depends on which circuit failed.' },
  { question: 'Can a MacBook Pro M4 logic board actually be repaired?', answer: 'Yes. The M4, M4 Pro and M4 Max chips are a single integrated SoC that no one can replace at chip level, but the surrounding circuits can. USB-C and Thunderbolt 5 controllers, power-management ICs, MagSafe 3 charging circuits and the XDR backlight driver are all discrete parts we diagnose and repair at component level in our Hyde Park workshop. Assessment.' },
  { question: 'My M4 MacBook Pro died after a load-shedding surge, is it fixable?', answer: 'Usually, yes. Surge spikes typically take out the USB-C power controller or power-management IC, not the M4 die itself, and those are discrete repairable components. The assessment confirms which circuit was hit and whether repair is viable before you commit.' },
  { question: 'Will my data be safe during M4 MacBook Pro board repair?', answer: 'Yes. Component-level repair does not remove or erase the soldered SSD, your storage stays on the board untouched while we repair the specific fault. If the board is completely dead, SSD readability is checked as part of the diagnostic.' },
  { question: 'How long does M4 MacBook Pro logic board repair take?', answer: 'After the assessment and your written approval, most M4 MacBook Pro board repairs finish within 3-5 business days. Multi-area liquid damage can take longer; the written quote states the timeline before we start.' },
...
const serviceSchema = {
  ...
  description: 'Component-level MacBook Pro M4, M4 Pro, M4 Max logic board repair in Johannesburg. Assessment.',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <p className="text-xl text-[#7A9E98] mb-4 max-w-3xl leading-relaxed">
              MacBook Pro M4 logic board repair in Johannesburg begins with an assessment and most repairs complete in 3-5 business days, far less than Apple’s full-board replacement. We repair the M4, M4 Pro and M4 Max (14-inch and 16-inch, 2024) at component level: no power, MagSafe 3 and USB-C charging, Thunderbolt 5, XDR backlight and liquid damage, in our Hyde Park workshop.
            </p>
      ...
      <section className="py-8 sm:py-16 bg-[#0A1A18]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-[rgba(39,80,77,0.3)] border border-[rgba(15,234,122,0.2)] rounded-3xl p-10">
            <h2 className="text-3xl font-extrabold text-[#E8F4F1] mb-3">MacBook Pro M4 Fault? Assessment.</h2>
