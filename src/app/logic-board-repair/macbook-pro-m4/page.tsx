...
const faqs = [
  { question: 'How much does MacBook Pro M4 logic board repair cost in Johannesburg?', answer: 'Apple replaces the entire board and quotes roughly R22,000–R55,000 for an M4 MacBook Pro. ZA Support repairs only the failed component on your existing board, which is significantly less. After the R599 assessment we give a written, fixed-price quote before any work begins. The exact price depends on which circuit failed.' },
