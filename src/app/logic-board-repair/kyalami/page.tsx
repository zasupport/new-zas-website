...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/logic-board-repair/kyalami', title: 'MacBook Logic Board Repair Kyalami | ZA Support Hyde Park', description: 'MacBook logic board repair for Kyalami residents. Component-level repair, board diagnostics, assessment. We collect from Kyalami and repair at our Hyde Park workshop. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
...
const faqs = [
  {
    question: 'Do you collect MacBooks from Kyalami?',
    answer: 'Yes. We offer a collection and return service for Kyalami clients. Your MacBook is collected from your home or office in Kyalami, repaired at our Hyde Park workshop approximately 22 minutes away, and returned once the repair is complete. Contact us on WhatsApp or by phone to arrange a collection time.',
  },
  {
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Kyalami', item: 'https://zasupport.com/logic-board-repair/kyalami' },
  ],
};

const faqSchema = buildFaqSchema(faqs);

export default function LogicBoardRepairKyalamiPage() {
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <div className="flex items-center gap-2 text-[#7A9E98] text-sm mb-8">
              ...
              <span>We collect from Kyalami and repair at our Hyde Park workshop, approx. 22 min drive</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href={buildWhatsAppUrl('LBR-KYALAMI', 'logic-board')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 hover:shadow-[0_0_32px_rgba(15,234,122,0.4)] transition-all">
                💬 WhatsApp for Quote
              </a>
      ...
      <section className="py-10 sm:py-20 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-[#E8F4F1] mb-8">
            Our Repair Process for Kyalami Clients
          </h2>
          <div className="space-y-6">
            {[
              { step: '01', title: 'Collection from Kyalami', desc: 'Contact us via WhatsApp or phone. We arrange a collection time from Kyalami that suits your schedule.' },
              ...
              { step: '05', title: 'Quality Check and Return', desc: 'Every repair is tested under load before return. Your MacBook is returned to Kyalami with a ZA Support warranty.' },
            ].map(({ step, title, desc }) => (
