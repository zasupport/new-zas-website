...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/logic-board-repair/alberton', title: 'MacBook Logic Board Repair Alberton | ZA Support Hyde Park', description: 'MacBook logic board repair for Alberton residents. Component-level repair, board diagnostics, assessment. We collect from Alberton and repair at our Hyde Park workshop. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
  title: 'MacBook Logic Board Repair Alberton | ZA Support Hyde Park',
  description:
    'MacBook logic board repair for Alberton residents. Component-level repair, board diagnostics, assessment. We collect from Alberton and repair at our Hyde Park workshop. Call 064 529 5863.',
...
const faqs = [
  ...
  { question: 'What is the assessment fee?', answer: 'Our assessment fee applies. That fee covers the full bench diagnostic, power sequencing checks, thermal imaging where relevant, microscope inspection and a written report telling you exactly which component has failed and what the repair will cost. If you choose to proceed, the assessment fee is credited against the repair cost.' },
  { question: 'Do you offer an Assessment guarantee?', answer: 'Yes. The assessment fee covers the diagnostic work itself. You receive a written quote before any chargeable repair work begins, so Alberton clients always know the full cost upfront. There are no hidden charges added afterwards, if the repair turns out to be uneconomical, you are told that plainly and only the assessment fee applies.' },
...
const serviceSchema = {
  ...
  description: 'Expert MacBook logic board repair and component-level repair for Alberton clients. Collection from Alberton, repair at Hyde Park workshop. Assessment.',
      ...
      <section className="py-8 sm:py-16 bg-[#0A1A18]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-[rgba(39,80,77,0.3)] border border-[rgba(15,234,122,0.2)] rounded-3xl p-10">
            <h2 className="text-3xl font-extrabold text-[#E8F4F1] mb-3">Alberton MacBook Fault? Assessment.</h2>
            <p className="text-[#7A9E98] mb-6">We collect from Alberton. Assessment. 12-month warranty. Hyde Park workshop.</p>
