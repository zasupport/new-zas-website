...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/logic-board-repair/benoni', title: 'MacBook Logic Board Repair Benoni | ZA Support Hyde Park', description: 'MacBook logic board repair for Benoni residents. Component-level repair, board diagnostics, assessment. We collect from Benoni and repair at our Hyde Park workshop. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
