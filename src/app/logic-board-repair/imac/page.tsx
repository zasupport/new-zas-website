...
export const metadata: Metadata = {
  title: 'iMac Logic Board Repair Johannesburg 2026 | From R 3,000 | ZA Support',
  description:
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              {
                title: 'No Fix No Fee',
                desc: 'If we cannot repair your iMac, you pay nothing — including the diagnostic. No shop in Johannesburg offers this combination with our repair depth.',
              },
              {
