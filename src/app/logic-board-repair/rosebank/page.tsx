...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/logic-board-repair/rosebank', title: 'MacBook Logic Board Repair Rosebank | ZA Support Hyde Park', description: 'MacBook logic board repair for Rosebank clients. Component-level repair specialists 9 minutes from Rosebank. Assessment, up-to-3 year warranty. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
...
const pricing = [
  { item: 'Diagnostic Assessment', note: 'Board-level inspection, to repair' },
...
const faqs = [
  ...
  },
  {
    ...
    answer: 'We inspect the logic board using schematics, a microscope, and power-supply diagnostic tools. We identify the specific failed component, test the surrounding circuitry, and assess whether the fault is repairable at component level or requires a board replacement. Assessment.',
  },
  {
    question: 'What warranty do you provide?',
    answer: 'Every logic board repair carries a ZA Support warranty covering the specific fault repaired and any directly related board failure. If the same fault recurs within the warranty period, we repair it at our assessment fee. Warranty is provided in writing with every completed repair.',
  },
];
    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href={buildWhatsAppUrl('LBR-ROSEBANK', 'logic-board')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 hover:shadow-[0_0_32px_rgba(15,234,122,0.4)] transition-all" >
                💬 WhatsApp for Quote
              </a>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="glass-card p-8">
              <h3 className="text-[#7A9E98] text-xl font-bold mb-4">Board Replacement (Last Resort)</h3>
              <ul className="space-y-3">
                {[
                  ...
                  'ZA Support warranty on replacement',
      ...
      <section className="py-10 sm:py-20 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-[#7A9E98] text-xs mt-3">Final quote given after assessment.</p>
