...
const pricing = [
  { item: 'Diagnostic Assessment', price: 'Free', note: 'Board-level inspection — no obligation to repair' },
  { item: 'USB-C / Thunderbolt Repair', price: 'From R 1,800', note: 'Controller chip or port board replacement' },
  { item: 'Power Circuit Repair', price: 'From R 2,000', note: 'No-power and charging failure repair' },
  { item: 'Microsoldering Repair', price: 'From R 2,500', note: 'Precision component-level board repair' },
  { item: 'GPU Repair / Reballing', price: 'From R 3,500', note: 'Discrete GPU — Intel-era Mac models only' },
  { item: 'Logic Board Replacement', price: 'From R 8,000', note: 'Full board swap when repair is not possible' },
];
    ...
    <>
      ...
      <section className="py-20 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-[#7A9E98] text-xs mt-3">Prices applicable to Rosebank clients. Final quote given after free diagnostic. No obligation to proceed.</p>
        </div>
      </section>
