...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/logic-board-repair/morningside', title: 'MacBook Logic Board Repair Morningside | ZA Support Hyde Park', description: 'MacBook logic board repair for Morningside clients. Component-level repair, assessment. We collect from Morningside. No Fix No Fee. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
...
const faqs = [
  {
    question: 'Do you collect MacBooks for logic board repair from Morningside?',
    answer: 'We collect from Morningside, Sandton, and the surrounding Johannesburg North area. We collect, repair at our Hyde Park workshop, and return once complete. WhatsApp 064 529 5863 to arrange.',
  },
  {
    question: 'How far is Morningside from your Hyde Park workshop?',
    answer: 'Approximately 8 km from Morningside to our workshop at 1 Hyde Lane, Second Floor, Office E2004, roughly 10-15 minutes by car. Morningside is approximately 8 km from our Hyde Park workshop, one of our closest collection areas.',
  },
  {
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Morningside', item: 'https://zasupport.com/logic-board-repair/morningside' },
  ],
};

const faqSchema = buildFaqSchema(faqs);

export default function LogicBoardRepairMorningsidePage() {
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <p className="text-xl text-[#7A9E98] mb-4 max-w-3xl leading-relaxed">
              Component-level MacBook logic board repair for Morningside clients. No power, charging faults, liquid damage, display failures, and USB-C faults repaired at our Hyde Park workshop. Collection from Morningside.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href={buildWhatsAppUrl('LBR-MORNINGSIDE', 'logic-board')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 hover:shadow-[0_0_32px_rgba(15,234,122,0.4)] transition-all" >
                WhatsApp for Quote
              </a>
      ...
      <section className="py-10 sm:py-20 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-[#E8F4F1] mb-4">MacBook Logic Board Faults We Repair for Morningside Clients</h2>
          <p className="text-[#7A9E98] mb-8 leading-relaxed">Morningside is approximately 8 km from our Hyde Park workshop, one of our closest collection areas. All MacBook models from 2015 onwards are covered, Intel and Apple Silicon. Faults assessed at component level. Written quote before any repair proceeds.</p>
      ...
      <section className="py-10 sm:py-20 bg-[#0A1A18]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <PricingNote />
          <FAQAccordion items={faqs} title={`MacBook Logic Board Repair Morningside, Common Questions`} />
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            {[
              ...
              { label: 'Liquid Damage Morningside', href: '/liquid-damage/morningside' },
              { label: 'Battery Replacement Morningside', href: '/battery-replacement/morningside' },
              { label: 'iPhone Repair Morningside', href: '/iphone-repair/screen/morningside' },
