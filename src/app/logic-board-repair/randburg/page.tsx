...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/logic-board-repair/randburg', title: 'MacBook Logic Board Repair Randburg | ZA Support Hyde Park', description: 'MacBook logic board repair for Randburg clients. Expert component-level repair, collect from Randburg, repair at Hyde Park workshop. Assessment. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
