...
export const metadata: Metadata = {
  ...
  description: 'MacBook logic board repair for Emmarentia clients. Component-level repair, assessment from R599. We collect from Emmarentia. No Fix No Fee. Call 064 529 5863.',
...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Assessment from R599. The repair cost depends on the specific fault — a written quote with the exact price is provided before any work proceeds. Component-level repair typically costs 60–80% less than Apple\'s full board replacement. No Fix No Fee applies to all Emmarentia clients.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Yes. If we cannot repair your MacBook after the assessment, you pay only the R599 assessment fee — not the full repair cost. This applies to all clients regardless of location. Collection from Emmarentia is included.',
  },
];
...
const serviceSchema = {
  ...
  description: 'Component-level MacBook logic board repair for Emmarentia clients. Assessment from R599. Collection included.',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <div className="flex items-center gap-2 text-[#7A9E98] text-sm mb-8">
              ...
              <span>Hyde Park, Johannesburg | Assessment from R599 | Collecting from Emmarentia — approx 10–12 min drive</span>
            </div>
