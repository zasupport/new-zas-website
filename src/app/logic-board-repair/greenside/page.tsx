...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/logic-board-repair/greenside', title: 'MacBook Logic Board Repair Greenside | ZA Support Hyde Park', description: 'MacBook logic board repair for Greenside clients. Component-level repair, assessment. We collect from Greenside. No Fix No Fee. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
  title: 'MacBook Logic Board Repair Greenside | ZA Support Hyde Park',
  description: 'MacBook logic board repair for Greenside clients. Component-level repair, assessment. We collect from Greenside. No Fix No Fee. Call 064 529 5863.',
  alternates: { canonical: 'https://zasupport.com/logic-board-repair/greenside' },
};
...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Assessment. The repair cost depends on the specific fault, a written quote with the exact price is provided before any work proceeds. Component-level repair typically costs 60-80% less than Apple\'s full board replacement. No Fix No Fee applies to all Greenside clients.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Yes. If we cannot repair your MacBook after the assessment, you pay only the assessment fee, not the full repair cost. This applies to all clients regardless of location. Collection from Greenside is included.',
  },
];
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'MacBook Logic Board Repair Greenside',
  description: 'Component-level MacBook logic board repair for Greenside clients. Assessment. Collection included.',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Greenside', item: 'https://zasupport.com/logic-board-repair/greenside' },
  ],
};

const faqSchema = buildFaqSchema(faqs);

export default function LogicBoardRepairGreensidePage() {
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <div className="flex items-center gap-2 text-[#7A9E98] text-sm mb-8">
              ...
              <span>Hyde Park, Johannesburg | Assessment | Collecting from Greenside, approx 8-12 min drive</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href={buildWhatsAppUrl('LBR-GREENSIDE', 'logic-board')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 hover:shadow-[0_0_32px_rgba(15,234,122,0.4)] transition-all">
                WhatsApp for Quote
              </a>
      ...
      <section className="py-8 sm:py-16 bg-[#0A1A18]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-[rgba(39,80,77,0.3)] border border-[rgba(15,234,122,0.2)] rounded-3xl p-10">
            ...
            <p className="text-[#7A9E98] mb-6">Collecting from Greenside. No Fix No Fee.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href={buildWhatsAppUrl('LBR-GREENSIDE', 'logic-board')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 transition-all">
                WhatsApp for Quote
              </a>
              <a href={`tel:${CONTACT.phoneTel}`} className="inline-flex items-center justify-center gap-2 border border-[rgba(15,234,122,0.35)] text-[#0FEA7A] px-8 py-4 rounded-xl text-lg font-semibold hover:bg-[rgba(15,234,122,0.08)] transition-all">
                <Phone className="w-5 h-5" /> Call {CONTACT.phone}
