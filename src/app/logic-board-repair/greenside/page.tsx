...
export const metadata: Metadata = {
  ...
  description: 'MacBook logic board repair for Greenside clients. Component-level repair, assessment from R599. We collect from Greenside. No Fix No Fee. Call 064 529 5863.',
...
const serviceSchema = {
  ...
  description: 'Component-level MacBook logic board repair for Greenside clients. Assessment from R599. Collection included.',
