...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/logic-board-repair/macbook-pro-m1', title: 'MacBook Pro M1 Logic Board Repair Johannesburg', description: 'MacBook Pro M1 logic board repair in Johannesburg. Charging faults, no power, black screen, USB-C failures, liquid damage. Component-level repair. Assessment. Hyde Park.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
