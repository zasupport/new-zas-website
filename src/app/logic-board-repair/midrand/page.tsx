...
export const metadata: Metadata = {
  ...
  description:
    'MacBook logic board repair for Midrand clients. Microsoldering specialists — collect from Midrand, repair at Hyde Park workshop. Free diagnostic, No Fix No Fee. Call 064 529 5863.',
...
const pricing = [
  { item: 'Diagnostic Assessment', price: 'Free', note: 'Component-level board inspection with no charge' },
  { item: 'USB-C / Thunderbolt Repair', price: 'From R 1,800', note: 'Port board or controller chip — Midrand collection available' },
  { item: 'Power Circuit Repair', price: 'From R 2,000', note: 'No-power and charging circuit fault repair' },
  { item: 'Microsoldering Repair', price: 'From R 2,500', note: 'Precision chip and component-level repair' },
  { item: 'GPU Repair / Reballing', price: 'From R 3,500', note: 'Intel discrete GPU models only' },
  { item: 'Logic Board Replacement', price: 'From R 8,000', note: 'Full replacement when repair is not viable' },
];
...
const serviceSchema = {
  ...
  description: 'MacBook logic board repair and microsoldering for Midrand clients. Collection from Midrand, repair at Hyde Park workshop. Free diagnostic. No Fix No Fee.',
    ...
    <>
      ...
      <section className="py-20 bg-[#0A1A18]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-[#7A9E98] text-xs mt-3">Final price confirmed after free diagnostic. Collection from Midrand included in service — no hidden charges.</p>
        </div>
      </section>
