...
const faqs = [
  ...
  { question: 'How much does MacBook Air M5 logic board repair cost?', answer: 'Apple replaces the whole board and quotes roughly R18,000–R35,000 for an M5 Air. ZA Support repairs only the failed component — component-level MacBook Air repairs start from R2,500 depending on the fault. After the R599 assessment we give a written, fixed-price quote before any work begins.' },
