...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/logic-board-repair/melville', title: 'MacBook Logic Board Repair Melville | ZA Support Hyde Park', description: 'MacBook logic board repair for Melville clients. Component-level repair, assessment. We collect from Melville. No Fix No Fee. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
...
const serviceSchema = {
  ...
  description: 'Component-level MacBook logic board repair for Melville clients. Assessment. Collection included.',
