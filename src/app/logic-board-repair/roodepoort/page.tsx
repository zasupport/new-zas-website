...
export const metadata: Metadata = {
  ...
  description:
    'MacBook logic board repair for Roodepoort residents. Component-level repair, board diagnostics, assessment from R599. We collect from Roodepoort and repair at our Hyde Park workshop. Call 064 529 5863.',
  alternates: { canonical: 'https://zasupport.com/logic-board-repair/roodepoort' },
};
...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Our workshop at 1 Hyde Park Lane is approximately 30 km from Roodepoort, roughly a 32-minute drive. Many clients drop their MacBook in on their way through and collect once the repair is complete. We are open Monday to Friday 08:00–17:30.',
  },
  {
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'MacBook Logic Board Repair Roodepoort',
  description: 'Expert MacBook logic board repair and component-level repair for Roodepoort clients. Collection from Roodepoort, repair at Hyde Park workshop. Assessment from R599.',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Roodepoort', item: 'https://zasupport.com/logic-board-repair/roodepoort' },
  ],
};

const faqSchema = buildFaqSchema(faqs);

export default function LogicBoardRepairRoodepoortPage() {
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <div className="flex items-center gap-2 text-[#7A9E98] text-sm mb-8">
              ...
              <span>We collect from Roodepoort and repair at our Hyde Park workshop, approx. 32 min drive</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href={buildWhatsAppUrl('LBR-ROODEPOO', 'logic-board')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 hover:shadow-[0_0_32px_rgba(15,234,122,0.4)] transition-all">
                💬 WhatsApp for Quote
              </a>
      ...
      <section className="py-8 sm:py-16 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-[#E8F4F1] mb-6">
            Logic Board Repair for Roodepoort Residents and Businesses
          </h2>
      ...
      <section className="py-10 sm:py-20 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-[#E8F4F1] mb-8">
            Our Repair Process for Roodepoort Clients
          </h2>
          <div className="space-y-6">
            {[
              { step: '01', title: 'Collection from Roodepoort', desc: 'Contact us via WhatsApp or phone. We arrange a collection time from Roodepoort that suits your schedule.' },
              ...
              { step: '05', title: 'Quality Check and Return', desc: 'Every repair is tested under load before return. Your MacBook is returned to Roodepoort with a ZA Support warranty.' },
            ].map(({ step, title, desc }) => (
      ...
      <section className="py-8 sm:py-16 bg-[#0A1A18]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-[rgba(39,80,77,0.3)] border border-[rgba(15,234,122,0.2)] rounded-3xl p-10">
            <h2 className="text-3xl font-extrabold text-[#E8F4F1] mb-3">Roodepoort MacBook Fault? Assessment from R599.</h2>
            <p className="text-[#7A9E98] mb-6">We collect from Roodepoort. Assessment from R599. 12-month warranty. Hyde Park workshop.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href={buildWhatsAppUrl('LBR-ROODEPOO', 'logic-board')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 transition-all">
                💬 WhatsApp for Quote
              </a>
              <a href={`tel:${CONTACT.phoneTel}`} className="inline-flex items-center justify-center gap-2 border border-[rgba(15,234,122,0.35)] text-[#0FEA7A] px-8 py-4 rounded-xl text-lg font-semibold hover:bg-[rgba(15,234,122,0.08)] transition-all">
                <Phone className="w-5 h-5" /> Call {CONTACT.phone}
