...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/logic-board-repair/randpark-ridge', title: 'MacBook Logic Board Repair Randpark Ridge | ZA Support Hyde Park', description: 'MacBook logic board repair for Randpark Ridge residents. Component-level repair, board diagnostics, assessment. We collect from Randpark Ridge and repair at our Hyde Park workshop. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
  title: 'MacBook Logic Board Repair Randpark Ridge | ZA Support Hyde Park',
  description:
    'MacBook logic board repair for Randpark Ridge residents. Component-level repair, board diagnostics, assessment. We collect from Randpark Ridge and repair at our Hyde Park workshop. Call 064 529 5863.',
  alternates: { canonical: 'https://zasupport.com/logic-board-repair/randpark-ridge' },
};
...
const faqs = [
  {
    question: 'Do you collect MacBooks from Randpark Ridge?',
    answer: 'Yes. We offer a collection and return service for Randpark Ridge clients. Your MacBook is collected from your home or office in Randpark Ridge, repaired at our Hyde Park workshop approximately 20 minutes away, and returned once the repair is complete. Contact us on WhatsApp or by phone to arrange a collection time.',
  },
  {
    question: 'How far is Randpark Ridge from your Hyde Park workshop?',
    answer: 'Our workshop at 1 Hyde Park Lane is approximately 18 km from Randpark Ridge, roughly a 20-minute drive. Many clients drop their MacBook in on their way through and collect once the repair is complete. We are open Monday to Thursday 08:00-17:00 and Friday 08:00-16:30.',
  },
  {
  ...
  {
    question: 'Which MacBook models do you repair for Randpark Ridge clients?',
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'MacBook Logic Board Repair Randpark Ridge',
  description: 'Expert MacBook logic board repair and component-level repair for Randpark Ridge clients. Collection from Randpark Ridge, repair at Hyde Park workshop. Assessment.',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Randpark Ridge', item: 'https://zasupport.com/logic-board-repair/randpark-ridge' },
  ],
};

const faqSchema = buildFaqSchema(faqs);

export default function LogicBoardRepairRandparkRidgePage() {
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[#E8F4F1] leading-tight mb-6">
              Logic Board Repair Randpark Ridge, Johannesburg
              <br /><span className="text-[#0FEA7A]">, MacBook Specialists</span>
            </h1>
            <p className="text-xl text-[#7A9E98] mb-4 max-w-3xl leading-relaxed">
              Randpark Ridge&apos;s preferred MacBook logic board repair service. We collect from Randpark Ridge and repair at our Hyde Park component-level workshop, approximately 20 minutes away. Assessment.
            </p>
            <div className="flex items-center gap-2 text-[#7A9E98] text-sm mb-8">
              <MapPin className="w-4 h-4 text-[#0FEA7A]" />
              <span>We collect from Randpark Ridge and repair at our Hyde Park workshop, approx. 20 min drive</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href={buildWhatsAppUrl('LBR-RANDPARK', 'logic-board')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 hover:shadow-[0_0_32px_rgba(15,234,122,0.4)] transition-all">
                💬 WhatsApp for Quote
              </a>
      ...
      <section className="py-8 sm:py-16 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4 text-[#7A9E98] leading-relaxed">
            ...
            <p>
              For Randpark Ridge clients, we offer a collection and return service. Your MacBook is collected from Randpark Ridge, Radiokop, and the north-western residential estates, repaired at our Hyde Park workshop, and returned to you once the repair is complete and fully tested. Most repairs are completed within 48-72 hours.
            </p>
            <p>
      ...
      <section className="py-10 sm:py-20 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-[#E8F4F1] mb-8">
            Our Repair Process for Randpark Ridge Clients
          </h2>
          <div className="space-y-6">
            {[
              { step: '01', title: 'Collection from Randpark Ridge', desc: 'Contact us via WhatsApp or phone. We arrange a collection time from Randpark Ridge that suits your schedule.' },
              ...
              { step: '05', title: 'Quality Check and Return', desc: 'Every repair is tested under load before return. Your MacBook is returned to Randpark Ridge with a ZA Support warranty.' },
            ].map(({ step, title, desc }) => (
      ...
      <section className="py-10 sm:py-20 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <PricingRange page="/logic-board-repair/randpark-ridge" />
      ...
      <section className="py-10 sm:py-20 bg-[#0A1A18]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <FAQAccordion items={faqs} title="Logic Board Repair Randpark Ridge, Common Questions" />
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
            {[
              ...
              { label: "Roodepoort", href: "/logic-board-repair/roodepoort" },
      ...
      <section className="py-8 sm:py-16 bg-[#0A1A18]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-[rgba(39,80,77,0.3)] border border-[rgba(15,234,122,0.2)] rounded-3xl p-10">
            <h2 className="text-3xl font-extrabold text-[#E8F4F1] mb-3">Randpark Ridge MacBook Fault? Assessment.</h2>
            <p className="text-[#7A9E98] mb-6">We collect from Randpark Ridge. Assessment. 12-month warranty. Hyde Park workshop.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href={buildWhatsAppUrl('LBR-RANDPARK', 'logic-board')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 transition-all">
                💬 WhatsApp for Quote
              </a>
              <a href={`tel:${CONTACT.phoneTel}`} className="inline-flex items-center justify-center gap-2 border border-[rgba(15,234,122,0.35)] text-[#0FEA7A] px-8 py-4 rounded-xl text-lg font-semibold hover:bg-[rgba(15,234,122,0.08)] transition-all">
                <Phone className="w-5 h-5" /> Call {CONTACT.phone}
