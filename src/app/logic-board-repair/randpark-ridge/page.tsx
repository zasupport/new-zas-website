...
export const metadata: Metadata = {
  ...
  description:
    'MacBook logic board repair for Randpark Ridge residents. Component-level repair, board diagnostics, assessment from R599. We collect from Randpark Ridge and repair at our Hyde Park workshop. Call 064 529 5863.',
...
const serviceSchema = {
  ...
  description: 'Expert MacBook logic board repair and component-level repair for Randpark Ridge clients. Collection from Randpark Ridge, repair at Hyde Park workshop. Assessment from R599.',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <p className="text-xl text-[#7A9E98] mb-4 max-w-3xl leading-relaxed">
              Randpark Ridge&apos;s preferred MacBook logic board repair service. We collect from Randpark Ridge and repair at our Hyde Park component-level workshop, approximately 20 minutes away. Assessment from R599.
            </p>
      ...
      <section className="py-8 sm:py-16 bg-[#0A1A18]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-[rgba(39,80,77,0.3)] border border-[rgba(15,234,122,0.2)] rounded-3xl p-10">
            <h2 className="text-3xl font-extrabold text-[#E8F4F1] mb-3">Randpark Ridge MacBook Fault? Assessment from R599.</h2>
            <p className="text-[#7A9E98] mb-6">We collect from Randpark Ridge. Assessment from R599. 12-month warranty. Hyde Park workshop.</p>
