...
export const metadata: Metadata = {
  ...
  description: 'MacBook logic board repair for Linden clients. Component-level repair, assessment from R599. We collect from Linden. No Fix No Fee. Call 064 529 5863.',
...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Assessment from R599. The repair cost depends on the specific fault — a written quote with the exact price is provided before any work proceeds. Component-level repair typically costs 60–80% less than Apple\'s full board replacement. No Fix No Fee applies to all Linden clients.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Yes. If we cannot repair your MacBook after the assessment, you pay only the R599 assessment fee — not the full repair cost. This applies to all clients regardless of location. Collection from Linden is included.',
  },
];
...
const serviceSchema = {
  ...
  description: 'Component-level MacBook logic board repair for Linden clients. Assessment from R599. Collection included.',
