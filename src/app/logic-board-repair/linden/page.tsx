...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/logic-board-repair/linden', title: 'MacBook Logic Board Repair Linden | ZA Support Hyde Park', description: 'MacBook logic board repair for Linden clients. Component-level repair, assessment. We collect from Linden. No Fix No Fee. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
  title: 'MacBook Logic Board Repair Linden | ZA Support Hyde Park',
  description: 'MacBook logic board repair for Linden clients. Component-level repair, assessment. We collect from Linden. No Fix No Fee. Call 064 529 5863.',
  alternates: { canonical: 'https://zasupport.com/logic-board-repair/linden' },
};

const faults = [
  { title: 'No Power', desc: 'MacBook shows no signs of life. We trace the power rail from the charging port through to the SoC power domain. The most common cause we see from Linden clients is USB-C controller or power management IC damage from load shedding surges, South Africa\'s grid instability accounts for roughly 35% of the no-power boards that arrive at our Hyde Park workshop.' },
...
const faqs = [
  {
    question: 'Do you collect MacBooks for logic board repair from Linden?',
    answer: 'Yes. We collect from Linden and the surrounding Johannesburg North area. Linden is approximately 7 km from our Hyde Park workshop, roughly 12-15 minutes by car. We collect, repair at our workshop at 1 Hyde Park Lane, and return once complete. WhatsApp 064 529 5863 to arrange same-day collection.',
  },
  {
    question: 'How far is Linden from your Hyde Park workshop?',
    answer: 'Approximately 7 km, roughly 12-15 minutes by car depending on traffic. Linden is one of our regular collection areas in Johannesburg North.',
  },
  {
    question: 'What does MacBook logic board repair cost for Linden clients?',
    answer: 'Assessment. The repair cost depends on the specific fault, a written quote with the exact price is provided before any work proceeds. Component-level repair typically costs 60-80% less than Apple\'s full board replacement. No Fix No Fee applies to all Linden clients.',
  },
  {
  ...
  {
    question: 'Do you offer No Fix No Fee for Linden clients?',
    answer: 'Yes. If we cannot repair your MacBook after the assessment, you pay only the assessment fee, not the full repair cost. This applies to all clients regardless of location. Collection from Linden is included.',
  },
];
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'MacBook Logic Board Repair Linden',
  description: 'Component-level MacBook logic board repair for Linden clients. Assessment. Collection included.',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Linden', item: 'https://zasupport.com/logic-board-repair/linden' },
  ],
};

const faqSchema = buildFaqSchema(faqs);

export default function LogicBoardRepairLindenPage() {
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <p className="text-xl text-[#7A9E98] mb-4 max-w-3xl leading-relaxed">
              Component-level MacBook logic board repair for Linden clients. No power, charging faults, liquid damage, display failures, and USB-C faults repaired at our Hyde Park workshop. Collection from Linden, approximately 7 km, 12-15 minutes by car.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href={buildWhatsAppUrl('LBR-LINDEN', 'logic-board')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 hover:shadow-[0_0_32px_rgba(15,234,122,0.4)] transition-all">
                WhatsApp for Quote
              </a>
      ...
      <section className="py-10 sm:py-20 bg-[#111C1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-[#E8F4F1] mb-4">MacBook Logic Board Faults We Repair for Linden Clients</h2>
          <p className="text-[#7A9E98] mb-8 leading-relaxed">Linden is approximately 7 km from our Hyde Park workshop, one of our regular collection areas in Johannesburg North. All MacBook models from 2015 onwards are covered, Intel and Apple Silicon. Every fault is assessed at component level with a written quote before any repair proceeds.</p>
      ...
      <section className="py-10 sm:py-20 bg-[#0A1A18]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <PricingNote />
          <FAQAccordion items={faqs} title={`MacBook Logic Board Repair Linden, Common Questions`} />
        </div>
      </section>
      ...
      <section className="py-8 sm:py-16 bg-[#0A1A18]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-[rgba(39,80,77,0.3)] border border-[rgba(15,234,122,0.2)] rounded-3xl p-10">
            ...
            <p className="text-[#7A9E98] mb-6">Collecting from Linden. No Fix No Fee.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href={buildWhatsAppUrl('LBR-LINDEN', 'logic-board')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#0FEA7A] text-[#0A1A18] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#0FEA7A]/90 transition-all">
                WhatsApp for Quote
              </a>
              <a href={`tel:${CONTACT.phoneTel}`} className="inline-flex items-center justify-center gap-2 border border-[rgba(15,234,122,0.35)] text-[#0FEA7A] px-8 py-4 rounded-xl text-lg font-semibold hover:bg-[rgba(15,234,122,0.08)] transition-all">
                <Phone className="w-5 h-5" /> Call {CONTACT.phone}
