...
export const metadata: Metadata = {
    openGraph: { url: 'https://zasupport.com/logic-board-repair/boksburg', title: 'MacBook Logic Board Repair Boksburg | ZA Support Hyde Park', description: 'MacBook logic board repair for Boksburg residents. Component-level repair, board diagnostics, assessment. We collect from Boksburg and repair at our Hyde Park workshop. Call 064 529 5863.', siteName: 'ZA Support', locale: 'en_ZA', type: 'website', images: [{ url: 'https://zasupport.com/og-image.jpg', width: 1200, height: 630 }] },
  title: 'MacBook Logic Board Repair Boksburg | ZA Support Hyde Park',
  description:
    'MacBook logic board repair for Boksburg residents. Component-level repair, board diagnostics, assessment. We collect from Boksburg and repair at our Hyde Park workshop. Call 064 529 5863.',
...
const faqs = [
  ...
  { question: 'What is the assessment fee?', answer: 'Our assessment applies. That covers the proper diagnostic, visual inspection, microscope review, power-rail testing and fault isolation, not a five-minute look-over. If you decide to go ahead with the repair, the assessment fee is absorbed into the repair cost. If you choose not to proceed, the machine is returned to Boksburg in the condition we received it.' },
  { question: 'Do you offer an Assessment guarantee?', answer: 'Yes. The Assessment is a firm starting point for diagnostic work on any MacBook logic board. We will tell you up front if your specific case requires anything beyond standard assessment, for example, a severely liquid-damaged board needing extensive cleaning before fault-finding can even begin. Boksburg clients receive a written quote after assessment, and no repair work begins without your approval.' },
...
const serviceSchema = {
  ...
  description: 'Expert MacBook logic board repair and component-level repair for Boksburg clients. Collection from Boksburg, repair at Hyde Park workshop. Assessment.',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <p className="text-xl text-[#7A9E98] mb-4 max-w-3xl leading-relaxed">
              Boksburg MacBook logic board repair, handled by a workshop that genuinely understands East Rand turnaround pressures. We collect from across Boksburg, from the homes near Cinderella Dam to the businesses along North Rand Road and the warehouses behind East Rand Mall, and repair at component level in our Hyde Park workshop, roughly 35 minutes away. Assessment.
            </p>
      ...
      <section className="py-8 sm:py-16 bg-[#0A1A18]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-[rgba(39,80,77,0.3)] border border-[rgba(15,234,122,0.2)] rounded-3xl p-10">
            <h2 className="text-3xl font-extrabold text-[#E8F4F1] mb-3">Boksburg MacBook Fault? Assessment.</h2>
            <p className="text-[#7A9E98] mb-6">We collect from Boksburg. Assessment. 12-month warranty. Hyde Park workshop.</p>
