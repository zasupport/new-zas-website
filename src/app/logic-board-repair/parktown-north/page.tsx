...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Assessment. The repair cost depends on the specific fault, a written quote with the exact price is provided before any work proceeds. Component-level repair typically costs 60-80% less than Apple\'s full board replacement. No Fix No Fee applies to all Parktown North clients.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Yes. If we cannot repair your MacBook after the assessment, you pay only the assessment fee, not the full repair cost. This applies to all clients regardless of location. Collection from Parktown North is included.',
  },
];
...
const serviceSchema = {
  ...
  description: 'Component-level MacBook logic board repair for Parktown North clients. Assessment. Collection included.',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl">
            ...
            <div className="flex items-center gap-2 text-[#7A9E98] text-sm mb-8">
              ...
              <span>Hyde Park, Johannesburg | Assessment | Collecting from Parktown North, approx 10-12 min drive</span>
            </div>
