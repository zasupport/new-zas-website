...
const services = [
  {
    ...
    desc: 'Logic board microsoldering, liquid damage, screen, battery, charging port. Same-day collection from your practice. Priority turnaround for Managed IT clients.',
    icon: '🔧',
  },
  {
