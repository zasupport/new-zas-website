...
export const LOCAL_BUSINESS_SCHEMA = {
  ...
  description: 'Johannesburg\'s Apple repair specialists. MacBook liquid damage, logic board microsoldering, iPhone & iPad repair. 3-month warranty. Assessment: R899 ex VAT.',
