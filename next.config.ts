...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    const routeRedirects = [
      ...
      { source: '/blog/unifi-installation-bryanston-johannesburg', destination: '/managed-services/unifi-networking', permanent: true },
      { source: '/blog/unifi-installation-fourways-johannesburg', destination: '/managed-services/unifi-networking', permanent: true },
      { source: '/blog/unifi-installation-rosebank-johannesburg', destination: '/managed-services/unifi-networking', permanent: true },
      { source: '/blog/unifi-installation-sandton-johannesburg', destination: '/managed-services/unifi-networking', permanent: true },
      { source: '/blog/unifi-installer-near-me-sandton-johannesburg', destination: '/managed-services/unifi-networking', permanent: true },
      { source: '/blog/unifi-installer-sandton-business-johannesburg', destination: '/managed-services/unifi-networking', permanent: true },
      { source: '/blog/unifi-troubleshooting-sandton-johannesburg', destination: '/managed-services/unifi-networking', permanent: true },
